...
from dexteritysdk.codegen.dex.types.print_trade import PrintTrade
...
class Accounts(Enum[U64]):
    ...
    PRINT_TRADE_PRODUCT = AccountDiscriminant(field=PrintTradeProduct)
    PRINT_TRADE_PRODUCT_INDEX = AccountDiscriminant(field=PrintTradeProductIndex)
    PRINT_TRADE = AccountDiscriminant(field=PrintTrade)
    ...
    LOCKED_COLLATERAL_PRODUCT_INDEX = AccountDiscriminant(field=LockedCollateralProductIndex)
