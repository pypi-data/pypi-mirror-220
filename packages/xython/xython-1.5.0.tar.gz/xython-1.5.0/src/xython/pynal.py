...
class pynal():
	...
	def change_dt_obj_to_text_time_set_as_dic(self, input_dt_obj):
		"""
	...
	def change_text_time_n_format_to_dt_obj(self, input_time, input_format):
		"""
	...
	def change_text_time_to_another_text_time_by_format(self, input_time, input_format):
		"""
		입력시간을 utc로 바꾸는 것
		"""
	...
	def minus_date0_date1_as_sec(self, input_date1, input_date2):
		"""
		두날짜의 빼기
		"""
	...
	def shift_text_time_by_month(self, input_time, input_no):
		"""
		기준날짜에서 월을 이동시키는것
		"""
		utf_time = self.check_input_time(input_time)
