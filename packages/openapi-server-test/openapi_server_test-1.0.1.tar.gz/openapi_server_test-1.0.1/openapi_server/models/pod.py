...
class Pod(Model):
    ...
    def __init__(self, labels=None, annotations=None, containers=None, topology_spread_constraints=None, volumes=None, affinity=None, security_context=None):  # noqa: E501
