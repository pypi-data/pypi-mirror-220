...
def bmcompiler_parser():
    ...
    parser.add_argument("method", choices=["download", "upload", "list", "init", "share", "uploadshare"], help="download or upload, you can do init first to avoid enter username and passwd  everytime")
...
def main():
    ...
    if a.method == 'upshare':
        un, pw = check_user_info(a)
        uploadshare(un, pw, a.local_dir, a.nas_dir)

    if a.method == 'share':
        un, pw = check_user_info(a)
        share(un, pw, a.local_dir, a.nas_dir)
