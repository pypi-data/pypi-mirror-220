...
setup(
  name = 'ESMSIND',         # How you named your package folder (MyLib)
  packages = ['ESMSIND'],   # Chose the same as "name"
  version = '3897',      # Start with a small number and increase it with every change you make
  license='MIT',        # Chose a license from here: https://help.github.com/articles/licensing-a-repository
  description = 'A python text messaging service using termux pip3 install pycryptodome from ESMSIND import *',   # Give a short description about your library
