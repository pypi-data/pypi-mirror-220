...
from .resources import get_module_and_function, log_exception
from .tele_logger import logger
...
def check_model(model_name: str, reference_model_name: str, apply_hierarchical: bool, reference_apply_hierarchical: List[bool]):
    """
    Chek model_name and apply_hierarchical constistency
    ...
    apply_hierarchical : bool
        Boolean value which specifies if apply hierarchical or not
    reference_apply_hierarchical : List[bool]
...
def config_parsing(config_path: str, config_filename: str, config_filename_parsing: str):
    """
    ...
    logger.info('Check Config Sections - OK')
    check_usecases(usecase = config_file['usecase']['usecase'], possible_usecases = config_file_parsing['usecase']['usecase'])
    logger.info('Check Config Section <usecase> - OK')
    check_model(model_name = config_file['model']['model_name'], reference_model_name = config_file_parsing['model']['model_name'], 
                apply_hierarchical = config_file['model']['apply_hierarchical'], reference_apply_hierarchical = config_file_parsing['model']['apply_hierarchical'] )
    logger.info('Check Config Section <model> - OK')
    ...
    logger.info('Check Config Section <hyperparameters> - OK')
    ...
    logger.info('Check Config Section <Preprocessing> - OK')
    ...
    logger.info('Check Config Section <Forecasting - Preprocessig> - OK')