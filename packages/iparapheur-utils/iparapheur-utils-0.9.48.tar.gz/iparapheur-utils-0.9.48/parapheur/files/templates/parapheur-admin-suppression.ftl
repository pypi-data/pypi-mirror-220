 ...
 text-align: left;">&nbsp; <i>i</i>-Parapheur</td>
    ...
    <tr><td style="border-left: 1px solid rgb(204, 204, 204); border-right: 1px solid rgb(204, 204, 204); border-bottom: 1px solid rgb(59, 89, 152); padding: 15px; background-color: rgb(255, 255, 255); font-family: 'lucida grande',tahoma,verdana,arial,sans-serif;" valign="top">
      <table width="100%"><tbody><tr><td style="font-size: 12px;" align="left" valign="top" width="100%">
             <div style="margin-bottom: 15px; font-size: 14px;">﻿Le dossier '${document.properties['cm:title']}' a été supprimé par ${person.properties.firstName}<#if person.properties.lastName?exists> ${person.properties.lastName}, en qualité d'administrateur de la plate-forme</#if>.
                 <br>Veuillez trouver en pièce jointe une fiche récapitulative de son état d'avancement dans i-Parapheur au moment de la suppression.
             </div>
             <div style="border-bottom: 1px solid rgb(204, 204, 204); line-height: 5px;">&nbsp;</div><br />

<#if annotation?? && annotation!="" && annotation!=" ">
             <div style="margin-bottom: 15px; font-size: 12px;"> <span style=" font-size:14px">${annotation?html?replace("\n", "<BR/>")}</span></div>
             <!--<div style="border-bottom: 1px solid rgb(204, 204, 204); line-height: 5px;">&nbsp;</div> --><br>
</#if>
             <!-- <div style="margin-bottom: 15px;">Vous ne pouvez plus y accéder via le parapheur électronique :</div> --> </td>
         </tr></tbody></table>
      </td>
    </tr>
<#if footer?? && footer!="" >
