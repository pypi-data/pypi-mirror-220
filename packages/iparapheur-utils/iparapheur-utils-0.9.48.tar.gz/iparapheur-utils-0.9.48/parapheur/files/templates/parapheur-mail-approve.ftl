...
<body>
    ...
    <div class="container">
        ...
        <div class="well">
            ...
            <p class="lead">
                <#if target == "owner">
                    Votre dossier ${dossierName} vient d'&ecirc;tre ${nomActionEffectuee} par ${nomValideur}.
                <#elseif target == "diff">
                    Le dossier ${dossierName} vient d'&ecirc;tre ${nomActionEffectuee} par ${nomValideur}.
                <#else>
                    Le dossier ${dossierName} vient d'arriver dans votre bureau ${nomParapheurCourant}
                    <#if asSecretary>
                        , dont vous êtes secrétaire,
                    </#if>

                    <#if nomActionDemandeee?lower_case == "archivage">
                        en fin de circuit
                    <#else>
                        pour ${nomActionDemandeee}
                    </#if>.
                </#if>
            </p>
