...
<body>
    ...
    <div class="container">
        ...
        <div class="well">
            ...
            <p class="lead">
                Le dossier ${dossierName} pr&eacute;c&eacute;demment arriv&eacute; dans votre bureau ${nomParapheurCourant} vient d'&ecirc;tre repris.<br/>
                Vous ne pouvez donc plus le traiter.
            </p>
