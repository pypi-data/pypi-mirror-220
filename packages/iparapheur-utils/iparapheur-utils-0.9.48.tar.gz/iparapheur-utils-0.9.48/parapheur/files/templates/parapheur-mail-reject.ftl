...
<body>
    ...
    <div class="container">
        ...
        <div class="well">
            ...
            <p class="lead">
                <#if target == "owner">
                    Votre dossier ${dossierName} vient de vous &ecirc;tre renvoy&eacute; sur votre bureau ${nomParapheurCourant}.
                    Il a &eacute;t&eacute; rejet&eacute; par ${nomValideur}.
                <#else>
                    Le dossier ${dossierName} vient d'&ecirc;tre rejet&eacute; par ${nomValideur}.
                </#if>
            </p>
