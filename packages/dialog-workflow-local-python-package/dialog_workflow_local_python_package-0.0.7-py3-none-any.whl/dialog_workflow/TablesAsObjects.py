...
class ProfileContext (object):
    def __init__(self):
        self.dict = {}
        self.profile_id = ACTIVE_PROFILE_ID
    ...
    def save_chosen_options(self, question_asked: str, variable_id: int, chosen_numbers_list: list[int], list_of_options: list[str]):
