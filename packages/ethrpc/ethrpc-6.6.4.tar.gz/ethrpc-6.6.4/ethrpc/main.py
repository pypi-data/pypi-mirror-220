...
from ethrpc._utils.encoding import (
    hex_encode_abi_type,
    to_hex,
    to_json,
)
...
from ethrpc._utils.module import (
    attach_modules as _attach_modules,
)
from ethrpc._utils.normalizers import (
    abi_ens_resolver,
)
from ethrpc.eth import (
    AsyncEth,
    Eth,
)
from ethrpc.geth import (
    AsyncGeth,
    AsyncGethAdmin,
    AsyncGethPersonal,
    AsyncGethTxPool,
...
from ethrpc.manager import (
    RequestManager as DefaultRequestManager,
)
from ethrpc.module import (
    Module,
)
from ethrpc.net import (
    AsyncNet,
    Net,
)
from ethrpc.providers import (
    AsyncBaseProvider,
    BaseProvider,
)
from ethrpc.providers.eth_tester import (
    EthereumTesterProvider,
)
from ethrpc.providers.ipc import (
    IPCProvider,
)
from ethrpc.providers.async_rpc import (
    AsyncHTTPProvider,
)
from ethrpc.providers.rpc import (
    HTTPProvider,
)
from ethrpc.providers.websocket import (
    WebsocketProvider,
)
from ethrpc.testing import (
    Testing,
)
from ethrpc.tracing import (
    Tracing,
)
...
if TYPE_CHECKING:
    from ethrpc.pm import PM  # noqa: F401
    from ethrpc._utils.empty import Empty  # noqa: F401
...
class BaseWeb3:
    ...
    @property
    def api(self) -> str:
        from ethrpc import __version__
    ...
    def attach_modules(
        ...
        """
        Attach modules to the `Ethrpc` instance.
        """
    ...
    def enable_unstable_package_management_api(self) -> None:
        if not hasattr(self, "_pm"):
            warnings.warn(
                ...
                "deprecated with ``ethrpc.py`` version 7",
                UserWarning,
            )
            from ethrpc.pm import PM  # noqa: F811
