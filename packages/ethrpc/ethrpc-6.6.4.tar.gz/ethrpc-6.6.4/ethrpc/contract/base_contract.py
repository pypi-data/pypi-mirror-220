...
class BaseContractEvent:
    ...
    event_name: str = None
    w3: Union["Ethrpc", "AsyncWeb3"] = None
...
class BaseContractEvents:
    ...
    .. code-block:: python
        ...
        >>> mycontract.events
        <ethrpc.contract.ContractEvents object at 0x108afde10>
    ...
    .. code-block:: python
        ...
        <class 'ethrpc._utils.datatypes.LogAnonymous'>
        ...
...
class BaseContract:
    ...
    :meth:`ethrpc.eth.Eth.contract` that takes compiled Solidity contract
