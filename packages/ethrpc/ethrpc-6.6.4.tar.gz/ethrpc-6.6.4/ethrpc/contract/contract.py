...
from ethrpc._utils.contracts import (
    parse_block_identifier,
)
from ethrpc._utils.datatypes import (
...
from ethrpc.contract.base_contract import (
    BaseContract,
    BaseContractCaller,
...
from ethrpc.contract.utils import (
...
class ContractEvent(BaseContractEvent):
    ...
    def get_logs(
        ...
        .. code-block:: python
            ...
            from = max(mycontract.ethrpc.eth.block_number - 10, 1)
            to = mycontract.ethrpc.eth.block_number
        ...
        See also: :func:`ethrpc.middleware.filter.local_filter_middleware`.
...
class ContractEvents(BaseContractEvents):
    def __init__(
        self, abi: ABI, w3: "Ethrpc", address: Optional[ChecksumAddress] = None
    ) -> None:
...
class ContractFunction(BaseContractFunction):
    ...
    def call(
        ...
        :param transaction: Dictionary of transaction info for ethrpc interface
...
class Contract(BaseContract):
    ...
    def __init__(self, address: Optional[ChecksumAddress] = None) -> None:
        ...
        if _w3 is None:
            raise AttributeError(
                ...
                "`ethrpc.contract` interface to create your contract class."
            )
    ...
    @classmethod
    def factory(
        cls, w3: "Ethrpc", class_name: Optional[str] = None, **kwargs: Any
    ) -> Type[Self]:
        kwargs["w3"] = w3
