...
from ethrpc.middleware.attrdict import (
    async_attrdict_middleware,
    attrdict_middleware,
)
from ethrpc.middleware.buffered_gas_estimate import (
    async_buffered_gas_estimate_middleware,
)
from ethrpc.providers import (
    BaseProvider,
)
from ethrpc.providers.async_base import (
    AsyncBaseProvider,
)
...
class AsyncEthereumTesterProvider(AsyncBaseProvider):
    ...
    def __init__(self) -> None:
        ...
        from ethrpc.providers.eth_tester.defaults import (
            API_ENDPOINTS,
        )
