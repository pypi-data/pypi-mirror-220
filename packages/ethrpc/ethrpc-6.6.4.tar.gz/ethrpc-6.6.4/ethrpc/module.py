...
def retrieve_blocking_method_call_fn(
    w3: "Ethrpc", module: "Module", method: Method[Callable[..., TReturn]]
...
#  Module should no longer have access to the full ethrpc api.
...
class Module:
    ...
    def __init__(self, w3: Union["AsyncWeb3", "Ethrpc"]) -> None:
        if self.is_async:
    ...
    def codec(self) -> ABICodec:
        # use codec set on the Ethrpc instance
