...
class GoEthereumPersonalModuleTest:
    ...
    def test_personal_lock_account(
        self, w3: "Ethrpc", unlockable_account_dual_type: ChecksumAddress
    ) -> None:
    ...
    def test_personal_new_account(self, w3: "Ethrpc") -> None:
    ...
    def test_personal_sign_and_ecrecover(
        ...
        message = "test-ethrpc-geth-personal-sign"
