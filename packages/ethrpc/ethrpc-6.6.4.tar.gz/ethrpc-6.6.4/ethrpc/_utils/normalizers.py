...
from ethrpc._utils.validation import (
    validate_abi,
    validate_address,
)
    ...
    if type_str == "address" and is_ens_name(val):
        if w3 is None:
            raise InvalidAddress(
                f"Could not look up name {val!r} because no ethrpc"
        ...
        if _ens is None:
            ...
            try:
                ...
                #  removed the mainnet requirement. Remove this in ethrpc.py v7 and allow
