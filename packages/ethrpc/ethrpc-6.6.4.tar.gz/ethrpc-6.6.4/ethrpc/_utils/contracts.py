...
def parse_block_identifier(
    w3: "Ethrpc", block_identifier: BlockIdentifier
) -> BlockIdentifier:
...
def parse_block_identifier_int(w3: "Ethrpc", block_identifier_int: int) -> BlockNumber:
...
def parse_block_identifier_no_extra_call(
    w3: Union["Ethrpc", "AsyncWeb3"], block_identifier: BlockIdentifier
) -> BlockIdentifier:
    if block_identifier is None:
        return w3.eth.default_block
