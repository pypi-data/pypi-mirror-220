...
from ethrpc.tools.pytest_ethereum.exceptions import (
    LinkerError,
)
...
def pluck_matching_uri(deployment_data: Dict[URI, Dict[str, str]], w3: Ethrpc) -> URI:
    """
...
def contains_matching_uri(deployment_data: Dict[str, Dict[str, str]], w3: Ethrpc) -> bool:
    """
