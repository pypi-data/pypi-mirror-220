...
from ethrpc._utils.function_identifiers import (
    FallbackFn,
    ReceiveFn,
)
...
if TYPE_CHECKING:
    from ethrpc.contract.async_contract import AsyncContractFunction  # noqa: F401
    from ethrpc.contract.contract import ContractFunction  # noqa: F401
...
# todo: move these to eth_typing once ethrpc is type hinted
...
Middleware = Callable[[Callable[[RPCEndpoint, Any], RPCResponse], "Ethrpc"], Any]
...
GasPriceStrategy = Union[
    Callable[["Ethrpc", TxParams], Wei], Callable[["AsyncWeb3", TxParams], Wei]
]
