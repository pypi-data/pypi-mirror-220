...
if TYPE_CHECKING:
    from ethrpc import Ethrpc  # noqa: F401
    from ethrpc.contract import (  # noqa: F401
        Contract,
    )
    from ethrpc.providers import (  # noqa: F401
        BaseProvider,
    )
    from ethrpc.types import (  # noqa: F401
        Middleware,
        TxParams,
    )
...
class ENS(BaseENS):
    ...
    def __init__(
        ...
        :type provider: instance of `ethrpc.providers.base.BaseProvider`
    ...
    @classmethod
    def from_web3(cls, w3: "Ethrpc", addr: ChecksumAddress = None) -> "ENS":
        """
        Generate an ENS instance from a Ethrpc instance

        :param `ethrpc.Ethrpc` w3: to infer connection, middleware, and codec information
    ...
    def setup_address(
        ...
        :param dict transact: the transaction configuration, like in
            :meth:`~ethrpc.eth.Eth.send_transaction`
        :raises InvalidName: if ``name`` has invalid syntax
    ...
    def setup_name(
        ...
        :param dict transact: the transaction configuration, like in
            :meth:`~ethrpc.eth.send_transaction`
