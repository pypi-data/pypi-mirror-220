...
class Package(object):
    def __init__(
        self, manifest: Dict[str, Any], w3: "Ethrpc", uri: Optional[str] = None
    ) -> None:
        """
    ...
    def update_w3(self, w3: "Ethrpc") -> "Package":
        """
        Returns a new instance of `Package` containing the same manifest,
        but connected to a different ethrpc instance.

        .. doctest::

           >>> new_w3 = Ethrpc(Ethrpc.EthereumTesterProvider())
    ...
    def get_contract_factory(self, name: ContractName) -> LinkableContract:
        ...
        ``ethrpc.contract.Contract``, ``ethpm.contract.LinkableContract`` with a few extra
    ...
    def get_contract_instance(self, name: ContractName, address: Address) -> Contract:
        """
        Will return a ``Ethrpc.contract`` instance generated from the contract type
