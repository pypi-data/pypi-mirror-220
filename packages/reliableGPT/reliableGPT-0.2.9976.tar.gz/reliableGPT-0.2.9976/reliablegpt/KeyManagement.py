...
class reliableKey:
    ...
    hot_cache = {}
    api_url = "https://reliablegpt-logging-server-7nq8.zeet-berri.zeet.app"
    valid_api_key = True
    ...
    def set_invalid_key(cls, invalid_key):
        ...
        openai.api_key = cls.get_key(llm_provider=openai.api_type)
        print(f"new openai key: {openai.api_key}")
