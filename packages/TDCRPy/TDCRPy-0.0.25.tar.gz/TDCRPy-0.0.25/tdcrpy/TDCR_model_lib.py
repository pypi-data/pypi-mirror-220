...
if absolutePath: 
    ...
    with importlib.resources.path('tdcrpy', 'MCNP-MATRIX', 'matrice', 'fichier') as data_path:
        fp1 = data_path / 'matrice_10ml-photon_1_200k.txt'      #gamma-10ml-1-200keV-niveau 0
        fp2 = data_path / 'matrice_10ml-photon_200_2000k.txt'   #gamma-10ml-200-2000keV-niveau 0
        fp3 = data_path / 'matrice_10ml-photon_2000_10000k.txt' #gamma-10ml-2000-10000keV-niveau 0
        fp4 = data_path / 'matrice_16ml-photon_1_200k.txt'      #gamma-10ml-1-200keV-niveau 0
        fp5 = data_path / 'matrice_16ml-photon_200_2000k.txt'      #gamma-10ml-1-200keV-niveau 0
        fe = data_path / 'E_depose.txt'
