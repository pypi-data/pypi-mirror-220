...
def TDCRPy(L, TD, TAB, TBC, TAC, Rad, pmf_1, N, kB, mode, mode2, Display=False, Dis2=True):
    """
    ...
    if X and Y:
        ...
        if Dis2 and not Display: NN = tqdm(range(N), desc="Processing", unit=" trial")
        else: NN = range(N)
