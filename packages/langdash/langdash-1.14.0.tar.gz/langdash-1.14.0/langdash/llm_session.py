from typing import TypeVar, Generic, Optional, List, Generator, Union, Tuple, Dict, Type, TYPE_CHECKING
import copy
...
class LLMGenerationSession(LLMSession, Generic[T_LLM, T_LLMState]):
  ...
  def _get_logit_preprocessor(self, T: Type[LogitPreprocessor]) -> LogitPreprocessor:
    try:
