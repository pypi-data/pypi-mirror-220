...
def ewma(
    ...
    as the data point gets older. It reacts more than the simple moving average with regard to recent movements.
    ...
    Args:
        ...
        time_window: Time window.
            Defines how important the current observation is in the calculation of the EWMA. The longer the period, the slower it adjusts to reflect current trends. Defaults to '60min'.
