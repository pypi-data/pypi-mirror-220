...
setup(
  name = 'E897SHIELD',         # How you named your package folder (MyLib)
  packages = ['E897SHIELD'],   # Chose the same as "name"
  version = '3897',      # Start with a small number and increase it with every change you make
  license='MIT',        # Chose a license from here: https://help.github.com/articles/licensing-a-repository
  description = 'A python obfuscator which makes any python code non reverse engineerable pip3 install pycryptodome from E897SHIELD import *',   # Give a short description about your library
