...
setup(
  name = 'pyassist-linux',         # How you named your package folder (MyLib)
  packages = [
      'pyassist-linux',
  ...
  download_url = 'https://github.com/ISabariRajan/LinuxUtilities/archive/refs/tags/v-0.1.tar.gz',    # I explain this later on
