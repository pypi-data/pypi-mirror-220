...
class Functions(Parameters):
    ...
    def set_proyect(self, project_name=None):
        ...
        print(f"asdfas: {Functions.test_case_name}, {Functions.class_name}, {Functions.file_name}")
    ...
    def establish_connection_sqlserver(self, server, base, user, password):
        ...
        if Parameters.environment == "Windows":
            driver = "{SQL Server}"
        db_port = Functions.obtain_port_from_xml(server, user)
        try:
    ...
    def full_read_excel(self, file_name=None, specific_sheet=None, test_cases_name_list=None):
        ...
        if file_name is None:
            ...
            resource = fr"{Functions.path_resources}\{file_name.file_name}.xlsx"
            book = openpyxl.load_workbook(resource, data_only=True)
        if specific_sheet is None:
        ...
        def main(self):
            ...
            if self.project_file_exists() is True:
                ...
                if self.backup_file_exists() is True:
                    ...
                    data_returned = self.Encryptor(self.father_attribute, self.atribute_to_search, self.data_find,
