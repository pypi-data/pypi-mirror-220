...
from geovisio import create_app, db_migrations, filesystems, tokens
...
class Picture(object):
    ...
    def get_permanent_file(self, datafiles):
        return os.path.join(datafiles, "permanent", self.id[0:2], self.id[2:4], self.id[4:6], self.id[6:8])
