...
def getTile(z: int, x: int, y: int, format: str):
    ...
    Layer "sequences":
      ...
      - Available properties: account_id,

    Layer "pictures":
      - Available on zoom levels >= 13
      - Available properties: id (picture ID), account_id, ts (picture date/time), heading (picture heading in degrees)
    ---
    tags:
        - Map
        - Pictures
