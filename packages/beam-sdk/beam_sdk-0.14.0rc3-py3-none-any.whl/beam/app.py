...
class Image:
    ...
    def data(self):
        ...
        # We inject the current version of beam into here
        beam_sdk_version = version("beam-sdk")
        python_packages.append(f"beam-sdk=={beam_sdk_version}")
...
class Volume:
    def __init__(self, name: str, path: str, volume_type: VolumeType):
        self.name = name
        self.app_path = path
