    ...
    def data(self):
        return {
            **self.kwargs,
            ...
            "autoscaling": Autoscaling.build_config(self.autoscaling) if self.autoscaling else None,
        }
...
class Volume:
    def __init__(self, name: str, path: str, volume_type: VolumeType = VolumeType.Shared):
        self.name = name
        self.app_path = path
...
class App:
    ...
    def task_queue(
        ...
        def decorator(func):
            ...
            parsed_path = self._parse_path(path, handler)
            config_data = {
