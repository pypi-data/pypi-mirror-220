...
@LastEditTime: 2023-07-10 11:36:14
        ...
        try:
            ...
            if score and operate_time > 0:
                ...
                if is_reset == True:
                    ...
                    expire_date = TimeHelper.format_time_to_datetime(hash_value["end_timestamp"])
                    if expire_date > now_date and queue_operate_total_time > 0:
                        remain_time = TimeHelper.difference_seconds(now_date, expire_date)
