...
selected_concept = ['顺周期', '资源股', '半导体产业', '光伏', '锂电池', '大消费', 'AI概念', '中特估']
...
class StockConception:
    ...
    def get_stock_concept_data(self):
        ...
        for date in trading_day_list:
            ...
            # 添加合成的AI概念指数
            ai_include = ['ChatGPT', 'AIGC', 'AI算力', '人工智能']
...
if __name__ == '__main__':
    StockConception('2022-03-07', '2023-04-07', is_increment=1).get_construct_result()