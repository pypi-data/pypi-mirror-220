...
if __name__ == '__main__':
    tmp = HoldingAnalysor("超量子1000增强9号", "20230331", "000905").get_construct_result(isPlot=False)
    ...
    # exposure_list = []
    # for date in ['20201231', '20210331', '20210630', '20210930', '20211231',
    #              '20220331', '20220630', '20220930', '20221231', '20230331']:
    #     print(date)
    #     c = HoldingAnalysor("衍复臻选指数增强一号", date, "000905").get_construct_result(isPlot=False)
