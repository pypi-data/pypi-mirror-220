...
@click.pass_obj
def plan_create(ctx: util.CliContext, template_id: int, inventory_files: list) -> None:
    """
    ...
    util.echo_msg(response, 'Plan Instance successfully created!', ctx.debug)
...
def plan_delete(ctx: util.CliContext, plan_id: int) -> None:
    ...
    util.echo_msg(response, 'Plan successfully deleted!', ctx.debug)
...
@click.option('-i', '--inventory-file', 'inventory_files', type=click.Path(exists=True), multiple=True,
              help="Inventory file used to fill the template. Can be used multiple times.")
@click.pass_obj
def plan_validate(ctx: util.CliContext, file: str, inventory_files: list) -> None:
    """
    ...
    response = api.post_request(ctx.api_url, api.PLAN_VALIDATE, files=files)

    util.echo_msg(response, 'Plan successfully validated!', ctx.debug)
...
def plan_execute(ctx: util.CliContext, plan_id: int, worker_id: int, run_id: int) -> None:
    ...
    util.echo_msg(response, 'Plan successfully executed!', ctx.debug)
...
def plan_get_plan(ctx: util.CliContext, plan_id: int, file: str, less: bool, localize: bool) -> None:
    ...
    util.get_yaml(response, file, f'plan-yaml_{plan_id}', less, less, localize, ctx.debug)
...
def plan_execution_delete(ctx: util.CliContext, execution_id: int) -> None:
    ...
    util.echo_msg(response, 'Plan execution successfully deleted!', ctx.debug)
...
def plan_execution_pause(ctx: util.CliContext, execution_id: int) -> None:
    ...
    util.echo_msg(response, 'Plan execution successfully paused!', ctx.debug)
...
def plan_execution_report(ctx: util.CliContext, execution_id: int, file: str, less: bool, localize: bool) -> None:
    ...
    util.get_yaml(response, file, f'report-plan-execution_{execution_id}', less, less, localize, ctx.debug)
...
def plan_execution_unpause(ctx: util.CliContext, execution_id: int) -> None:
    ...
    util.echo_msg(response, 'Plan execution successfully resumed!', ctx.debug)
...
def plan_execution_validate_modules(ctx: util.CliContext, execution_id: int) -> None:
    ...
    util.echo_msg(response, 'Modules were validated!', ctx.debug)
...
def plan_execution_kill(ctx: util.CliContext, execution_id: int) -> None:
    ...
    util.echo_msg(response, 'Plan execution successfully killed!', ctx.debug)
