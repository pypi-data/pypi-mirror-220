...
@click.pass_obj
def stage_create(ctx: util.CliContext, plan_id: int, file: str, inventory_files: list) -> None:
    """
    ...
    response = api.post_request(ctx.api_url, api.STAGE_CREATE, files=files, data={'plan_id': plan_id})

    util.echo_msg(response, 'Stage successfully created!', ctx.debug)
...
def stage_delete(ctx: util.CliContext, stage_id: int) -> None:
    ...
    util.echo_msg(response, 'Stage successfully deleted!', ctx.debug)
...
@click.pass_obj
def stage_validate(ctx: util.CliContext, file: str, inventory_files: list, dynamic: bool) -> None:
    """
    ...
    response = api.post_request(ctx.api_url, api.STAGE_VALIDATE, files=files, data=data)

    util.echo_msg(response, 'Stage successfully validated!', ctx.debug)
...
@click.pass_obj
def stage_start_trigger(ctx: util.CliContext, stage_id: int, plan_execution_id: int) -> None:
    """
    ...
    response = api.post_request(ctx.api_url, api.STAGE_START_TRIGGER, stage_id, custom_dict=arguments)

    util.echo_msg(response, 'Stage\'s trigger successfully started!', ctx.debug)
...
def stage_execution_delete(ctx: util.CliContext, execution_id: int) -> None:
    ...
    util.echo_msg(response, 'Stage execution successfully deleted!', ctx.debug)
...
def stage_execution_report(ctx: util.CliContext, execution_id: int, file: str, less: bool,
    ...
    util.get_yaml(response, file, f'report-stage-execution_{execution_id}', less, less, localize, ctx.debug)
...
def stage_execution_kill(ctx: util.CliContext, execution_id: int) -> None:
    ...
    util.echo_msg(response, 'Stage execution successfully killed!', ctx.debug)
...
def stage_execution_re_execute(ctx: util.CliContext, execution_id: int, immediately: bool) -> None:
    ...
    util.echo_msg(response, 'Stage execution successfully re-executed!', ctx.debug)
