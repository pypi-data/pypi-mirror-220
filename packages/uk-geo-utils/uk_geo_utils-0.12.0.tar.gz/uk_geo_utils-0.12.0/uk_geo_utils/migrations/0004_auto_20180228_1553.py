...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RemoveField(model_name="onspd", name="oldha"),
        migrations.RemoveField(model_name="onspd", name="oldpct"),
        migrations.RemoveField(model_name="onspd", name="oshaprev"),
        migrations.RemoveField(model_name="onspd", name="psed"),
        migrations.RemoveField(model_name="onspd", name="streg"),
        migrations.RemoveField(model_name="onspd", name="ward98"),
        migrations.RemoveField(model_name="onspd", name="wardc91"),
        migrations.RemoveField(model_name="onspd", name="wardo91"),
        migrations.AddField(
            model_name="onspd",
            name="ced",
