...
from wow_ai_mms import utils as wow_ai_mms_utils
from wow_ai_mms._logger import set_log_level
from wow_ai_mms.models.alignment import AlignmentModel
from wow_ai_mms import constants
...
class ASRModel:
    ...
    def transcribe(self,
        ...
        if align:
            ...
            for i in range(len(transcripts)):
                ...
                transcript = wow_ai_mms_utils.get_transcript_segments(transcripts[i], timestamps_type, max_segment_len=max_segment_len)
    ...
    def _reorder_decode(hypos):
        ...
        [#5](https://github.com/abdeladim-s/wow_ai_mms/issues/5)
