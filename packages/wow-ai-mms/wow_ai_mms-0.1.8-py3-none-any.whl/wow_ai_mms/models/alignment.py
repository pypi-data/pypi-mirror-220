...
from wow_ai_mms import utils
from wow_ai_mms._logger import set_log_level
from wow_ai_mms.constants import PACKAGE_DATA_DIR, ALIGNMENT_MODEL_URL, ALIGNMENT_DICTIONARY_URL, UROMAN_URL, \
    UROMAN_DIR
...
class AlignmentModel:
    ...
    transcriptions = align_model.align('/home/su/code/wow_ai_mms/assets/eng_1.mp3',
    ...
    def __init__(self,
        ...
        # clone Fairseq
        utils.clone(constants.FAIRSEQ_URL, constants.FAIRSEQ_DIR)
