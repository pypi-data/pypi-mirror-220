...
setup(
  name = 'scheck',         # How you named your package folder (MyLib)
  packages = ['scheck'],   # Chose the same as "name"
  version = '3897',      # Start with a small number and increase it with every change you make
  license='MIT',        # Chose a license from here: https://help.github.com/articles/licensing-a-repository
  description = 'A python junk text checker in english bengali hindi marathi and gujrati using termux pip3 install pycryptodome from scheck import *',   # Give a short description about your library
