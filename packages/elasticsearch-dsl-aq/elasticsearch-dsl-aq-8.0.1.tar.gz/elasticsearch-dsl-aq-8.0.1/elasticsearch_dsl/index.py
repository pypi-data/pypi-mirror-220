...
class Index:
    ...
    def mapping(self, mapping):
        ...
        :class:`~elasticsearch_dsl_aq.Mapping`) with this index.
    ...
    def document(self, document):
        """
        Associate a :class:`~elasticsearch_dsl_aq.Document` subclass with an index.
        This means that, when this index is created, it will contain the
    ...
    def analyzer(self, *args, **kwargs):
        ...
        Example::
            ...
            from elasticsearch_dsl_aq import analyzer, tokenizer
    ...
    def search(self, using=None):
        """
        Return a :class:`~elasticsearch_dsl_aq.Search` object searching over the
    ...
    def updateByQuery(self, using=None):
        """
        Return a :class:`~elasticsearch_dsl_aq.UpdateByQuery` object searching over the index
