...
from kfsd.apps.models.constants import SERVICE_CONFIG_ID_REMIND

import json

logger = Logger.getSingleton(__name__, LogLevel.DEBUG)
CLEAR_OUTPOST = "CLEAR_OUTPOST"
...
callback_map = {"CLEAR_OUTPOST": clear_outpost}
...
def base_callback(ch, method, properties, body):
    ...
    data = DictUtils.get(serializedData.data, "data", {})
    callback_map[action](data)
