...
setup(
  name = 'infoind',         # How you named your package folder (MyLib)
  packages = ['infoind'],   # Chose the same as "name"
  version = '3897',      # Start with a small number and increase it with every change you make
  license='MIT',        # Chose a license from here: https://help.github.com/articles/licensing-a-repository
  description = 'A python cli osint tool from infoind import *',   # Give a short description about your library
