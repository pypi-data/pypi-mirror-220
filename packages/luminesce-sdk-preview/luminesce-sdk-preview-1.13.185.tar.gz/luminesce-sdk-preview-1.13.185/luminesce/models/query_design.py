...
class QueryDesign(object):
    ...
    def __init__(self, table_name=None, alias=None, fields=None, order_by=None, limit=None, warnings=None, local_vars_configuration=None):  # noqa: E501
        ...
        :type limit: int
        :param warnings:  And warnings to show the user when converting from SQL to this representation
    ...
    def warnings(self):
        ...
        And warnings to show the user when converting from SQL to this representation  # noqa: E501
