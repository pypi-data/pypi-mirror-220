...
from sportmonks.model.sport_referee_by_id_response import SportRefereeByIdResponse as SportRefereeByIdResponseSchema

from sportmonks.type.sport_referee_by_id_response import SportRefereeByIdResponse

# Path params
VersionSchema = schemas.StrSchema
SportSchema = schemas.StrSchema
RefereeIdSchema = schemas.IntSchema
...
request_path_referee_id = api_client.PathParameter(
    name="refereeId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=RefereeIdSchema,
    required=True,
)
SchemaFor0ResponseBodyApplicationJson = SportRefereeByIdResponseSchema


@dataclass
class ApiResponseForDefault(api_client.ApiResponse):
    body: SportRefereeByIdResponse
...
class BaseApi(api_client.Api):
    ...
    def _referee_by_id_mapped_args(
        ...
        if referee_id is not None:
            _path_params["refereeId"] = referee_id
        args.path = _path_params
        return args

    async def _areferee_by_id_oapg(
        self,
