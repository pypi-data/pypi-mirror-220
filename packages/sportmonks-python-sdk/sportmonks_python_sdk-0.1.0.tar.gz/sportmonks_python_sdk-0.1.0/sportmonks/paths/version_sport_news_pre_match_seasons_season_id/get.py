...
from sportmonks.model.sport_news_pre_match_by_season_id_response import SportNewsPreMatchBySeasonIdResponse as SportNewsPreMatchBySeasonIdResponseSchema

from sportmonks.type.sport_news_pre_match_by_season_id_response import SportNewsPreMatchBySeasonIdResponse
...
SchemaFor200ResponseBodyApplicationJson = SportNewsPreMatchBySeasonIdResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: SportNewsPreMatchBySeasonIdResponse
...
class BaseApi(api_client.Api):
    ...
    def _news_pre_match_by_season_id_mapped_args(
        self,
        season_id: int,
    ...
    async def _anews_pre_match_by_season_id_oapg(
        self,
    ...
    def _news_pre_match_by_season_id_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
...
class NewsPreMatchBySeasonId(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def anews_pre_match_by_season_id(
        self,
        season_id: int,
        version: typing.Optional[str] = None,
        sport: typing.Optional[str] = None,
        ...
        args = self._news_pre_match_by_season_id_mapped_args(
            season_id=season_id,
            version=version,
            sport=sport,
        )
        return await self._anews_pre_match_by_season_id_oapg(
            path_params=args.path,
        )
    
    def news_pre_match_by_season_id(
        self,
        season_id: int,
        version: typing.Optional[str] = None,
        sport: typing.Optional[str] = None,
        ...
        return self._news_pre_match_by_season_id_oapg(
            path_params=args.path,
        )
