...
from sportmonks.model.sport_fixture_by_date_range_for_team_response import SportFixtureByDateRangeForTeamResponse as SportFixtureByDateRangeForTeamResponseSchema

from sportmonks.type.sport_fixture_by_date_range_for_team_response import SportFixtureByDateRangeForTeamResponse
...
SchemaFor0ResponseBodyApplicationJson = SportFixtureByDateRangeForTeamResponseSchema


@dataclass
class ApiResponseForDefault(api_client.ApiResponse):
    body: SportFixtureByDateRangeForTeamResponse
...
class BaseApi(api_client.Api):
    ...
    async def _afixture_by_date_range_for_team_oapg(
        self,
    ...
    def _fixture_by_date_range_for_team_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
...
class FixtureByDateRangeForTeam(BaseApi):
