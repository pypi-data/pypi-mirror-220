...
from sportmonks.model.sport_predictions_all_value_bets_response import SportPredictionsAllValueBetsResponse as SportPredictionsAllValueBetsResponseSchema

from sportmonks.type.sport_predictions_all_value_bets_response import SportPredictionsAllValueBetsResponse
...
SchemaFor200ResponseBodyApplicationJson = SportPredictionsAllValueBetsResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: SportPredictionsAllValueBetsResponse
...
class BaseApi(api_client.Api):
    ...
    def _predictions_all_value_bets_mapped_args(
        self,
    ...
    async def _apredictions_all_value_bets_oapg(
        self,
    ...
    def _predictions_all_value_bets_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
...
class PredictionsAllValueBets(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def apredictions_all_value_bets(
        self,
        version: typing.Optional[str] = None,
        sport: typing.Optional[str] = None,
    ) -> typing.Union[
        ...
        args = self._predictions_all_value_bets_mapped_args(
            version=version,
            sport=sport,
        )
        return await self._apredictions_all_value_bets_oapg(
            path_params=args.path,
        )
    
    def predictions_all_value_bets(
        self,
        version: typing.Optional[str] = None,
        sport: typing.Optional[str] = None,
    ) -> typing.Union[
        ...
        return self._predictions_all_value_bets_oapg(
            path_params=args.path,
        )
