...
from sportmonks.model.sport_top_scorers_by_stage_id_response import SportTopScorersByStageIdResponse as SportTopScorersByStageIdResponseSchema

from sportmonks.type.sport_top_scorers_by_stage_id_response import SportTopScorersByStageIdResponse
...
SchemaFor0ResponseBodyApplicationJson = SportTopScorersByStageIdResponseSchema


@dataclass
class ApiResponseForDefault(api_client.ApiResponse):
    body: SportTopScorersByStageIdResponse
...
class BaseApi(api_client.Api):
    ...
    async def _atop_scorers_by_stage_id_oapg(
        self,
    ...
    def _top_scorers_by_stage_id_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
...
class TopScorersByStageId(BaseApi):
