...
from sportmonks.model.sport_odds_all_in_play_response import SportOddsAllInPlayResponse as SportOddsAllInPlayResponseSchema

from sportmonks.type.sport_odds_all_in_play_response import SportOddsAllInPlayResponse
...
SchemaFor200ResponseBodyApplicationJson = SportOddsAllInPlayResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: SportOddsAllInPlayResponse
...
class BaseApi(api_client.Api):
    ...
    def _odds_all_in_play_mapped_args(
        self,
    ...
    async def _aodds_all_in_play_oapg(
        self,
...
class OddsAllInPlay(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aodds_all_in_play(
        self,
        version: typing.Optional[str] = None,
        sport: typing.Optional[str] = None,
    ) -> typing.Union[
        ...
        args = self._odds_all_in_play_mapped_args(
            version=version,
            sport=sport,
        )
        return await self._aodds_all_in_play_oapg(
            path_params=args.path,
        )
    
    def odds_all_in_play(
        self,
        version: typing.Optional[str] = None,
        sport: typing.Optional[str] = None,
    ) -> typing.Union[
        ...
        return self._odds_all_in_play_oapg(
            path_params=args.path,
        )
