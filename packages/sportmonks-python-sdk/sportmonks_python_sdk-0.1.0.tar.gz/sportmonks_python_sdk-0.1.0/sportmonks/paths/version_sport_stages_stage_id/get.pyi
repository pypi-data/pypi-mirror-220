...
from sportmonks.model.sport_stage_by_id_response import SportStageByIdResponse as SportStageByIdResponseSchema

from sportmonks.type.sport_stage_by_id_response import SportStageByIdResponse

# Path params
VersionSchema = schemas.StrSchema
SportSchema = schemas.StrSchema
StageIdSchema = schemas.IntSchema
...
SchemaFor0ResponseBodyApplicationJson = SportStageByIdResponseSchema


@dataclass
class ApiResponseForDefault(api_client.ApiResponse):
    body: SportStageByIdResponse
...
class StageById(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def astage_by_id(
        self,
        stage_id: int,
        version: typing.Optional[str] = None,
        sport: typing.Optional[str] = None,
        ...
        args = self._stage_by_id_mapped_args(
            stage_id=stage_id,
            version=version,
            sport=sport,
        )
        return await self._astage_by_id_oapg(
