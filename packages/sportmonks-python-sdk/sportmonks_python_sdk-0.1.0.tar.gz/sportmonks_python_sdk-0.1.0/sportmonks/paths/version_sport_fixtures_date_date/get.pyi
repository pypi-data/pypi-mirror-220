...
from sportmonks.model.sport_fixtures_by_date_response import SportFixturesByDateResponse as SportFixturesByDateResponseSchema

from sportmonks.type.sport_fixtures_by_date_response import SportFixturesByDateResponse
...
SchemaFor0ResponseBodyApplicationJson = SportFixturesByDateResponseSchema


@dataclass
class ApiResponseForDefault(api_client.ApiResponse):
    body: SportFixturesByDateResponse
...
class BaseApi(api_client.Api):
    ...
    async def _afixtures_by_date_oapg(
        self,
