...
from sportmonks.model.sport_season_by_id_response import SportSeasonByIdResponse as SportSeasonByIdResponseSchema

from sportmonks.type.sport_season_by_id_response import SportSeasonByIdResponse
...
SchemaFor0ResponseBodyApplicationJson = SportSeasonByIdResponseSchema


@dataclass
class ApiResponseForDefault(api_client.ApiResponse):
    body: SportSeasonByIdResponse
...
class SeasonById(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aseason_by_id(
        self,
        season_id: int,
        version: typing.Optional[str] = None,
        sport: typing.Optional[str] = None,
        ...
        args = self._season_by_id_mapped_args(
            season_id=season_id,
            version=version,
            sport=sport,
        )
        return await self._aseason_by_id_oapg(
    ...
    def season_by_id(
        ...
        return self._season_by_id_oapg(
            path_params=args.path,
        )
