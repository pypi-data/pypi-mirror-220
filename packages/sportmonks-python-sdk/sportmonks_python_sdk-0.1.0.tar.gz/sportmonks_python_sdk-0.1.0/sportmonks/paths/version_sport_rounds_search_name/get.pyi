...
from sportmonks.model.sport_rounds_search_response import SportRoundsSearchResponse as SportRoundsSearchResponseSchema

from sportmonks.type.sport_rounds_search_response import SportRoundsSearchResponse
...
SchemaFor0ResponseBodyApplicationJson = SportRoundsSearchResponseSchema


@dataclass
class ApiResponseForDefault(api_client.ApiResponse):
    body: SportRoundsSearchResponse
...
class BaseApi(api_client.Api):
    ...
    async def _arounds_search_oapg(
        self,
