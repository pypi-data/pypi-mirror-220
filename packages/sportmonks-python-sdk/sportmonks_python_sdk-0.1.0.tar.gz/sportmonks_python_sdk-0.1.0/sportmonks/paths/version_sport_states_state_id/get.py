...
from sportmonks.model.sport_state_by_id_response import SportStateByIdResponse as SportStateByIdResponseSchema

from sportmonks.type.sport_state_by_id_response import SportStateByIdResponse
...
StateIdSchema = schemas.IntSchema
...
request_path_state_id = api_client.PathParameter(
    name="stateId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=StateIdSchema,
    required=True,
)
_auth = [
    'apikeyAuth',
]
SchemaFor0ResponseBodyApplicationJson = SportStateByIdResponseSchema


@dataclass
class ApiResponseForDefault(api_client.ApiResponse):
    body: SportStateByIdResponse
