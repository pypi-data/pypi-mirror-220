...
class BaseApi(api_client.Api):
    ...
    def _fixtures_latest_mapped_args(
        self,
    ...
    async def _afixtures_latest_oapg(
        self,
...
class FixturesLatest(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def afixtures_latest(
        self,
        version: typing.Optional[str] = None,
        sport: typing.Optional[str] = None,
    ) -> typing.Union[
        ...
        args = self._fixtures_latest_mapped_args(
            version=version,
            sport=sport,
        )
        return await self._afixtures_latest_oapg(
    ...
    def fixtures_latest(
        ...
        return self._fixtures_latest_oapg(
            path_params=args.path,
        )
