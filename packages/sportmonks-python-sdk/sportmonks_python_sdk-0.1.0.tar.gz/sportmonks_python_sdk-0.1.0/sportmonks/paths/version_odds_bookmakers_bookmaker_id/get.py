...
from sportmonks.model.odds_bookmaker_by_id_response import OddsBookmakerByIdResponse as OddsBookmakerByIdResponseSchema

from sportmonks.type.odds_bookmaker_by_id_response import OddsBookmakerByIdResponse
...
SchemaFor0ResponseBodyApplicationJson = OddsBookmakerByIdResponseSchema


@dataclass
class ApiResponseForDefault(api_client.ApiResponse):
    body: OddsBookmakerByIdResponse
...
class BaseApi(api_client.Api):
    ...
    async def _abookmaker_by_id_oapg(
        self,
