...
from sportmonks.model.sport_news_all_pre_match_response import SportNewsAllPreMatchResponse as SportNewsAllPreMatchResponseSchema

from sportmonks.type.sport_news_all_pre_match_response import SportNewsAllPreMatchResponse
...
SchemaFor200ResponseBodyApplicationJson = SportNewsAllPreMatchResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: SportNewsAllPreMatchResponse
...
class BaseApi(api_client.Api):
    ...
    def _news_all_pre_match_mapped_args(
        self,
    ...
    async def _anews_all_pre_match_oapg(
        self,
...
class NewsAllPreMatch(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def anews_all_pre_match(
        self,
        version: typing.Optional[str] = None,
        sport: typing.Optional[str] = None,
    ) -> typing.Union[
        ...
        args = self._news_all_pre_match_mapped_args(
            version=version,
            sport=sport,
        )
        return await self._anews_all_pre_match_oapg(
            path_params=args.path,
        )
    
    def news_all_pre_match(
        self,
        version: typing.Optional[str] = None,
        sport: typing.Optional[str] = None,
    ) -> typing.Union[
        ...
        return self._news_all_pre_match_oapg(
            path_params=args.path,
        )
