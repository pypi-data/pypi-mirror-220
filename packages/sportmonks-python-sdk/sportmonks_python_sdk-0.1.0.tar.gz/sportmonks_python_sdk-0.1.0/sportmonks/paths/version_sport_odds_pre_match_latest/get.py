...
class BaseApi(api_client.Api):
    ...
    async def _aodds_latest_pre_match_oapg(
        self,
    ...
    def _odds_latest_pre_match_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
...
class OddsLatestPreMatch(BaseApi):
    ...
    async def aodds_latest_pre_match(
        ...
        args = self._odds_latest_pre_match_mapped_args(
            version=version,
            sport=sport,
        )
        return await self._aodds_latest_pre_match_oapg(
    ...
    def odds_latest_pre_match(
        ...
        return self._odds_latest_pre_match_oapg(
            path_params=args.path,
        )
