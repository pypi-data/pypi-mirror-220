...
from sportmonks.model.my_enrichments_response import MyEnrichmentsResponse as MyEnrichmentsResponseSchema

from sportmonks.type.my_enrichments_response import MyEnrichmentsResponse
...
class Enrichments(BaseApi):
    ...
    async def aenrichments(
        ...
        args = self._enrichments_mapped_args(
            version=version,
        )
        return await self._aenrichments_oapg(
