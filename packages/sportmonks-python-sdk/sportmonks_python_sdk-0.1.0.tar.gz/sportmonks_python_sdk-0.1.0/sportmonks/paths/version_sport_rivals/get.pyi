...
from sportmonks.model.sport_rivals_all_response import SportRivalsAllResponse as SportRivalsAllResponseSchema

from sportmonks.type.sport_rivals_all_response import SportRivalsAllResponse
...
SchemaFor200ResponseBodyApplicationJson = SportRivalsAllResponseSchema
...
class RivalsAll(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def arivals_all(
        self,
        version: typing.Optional[str] = None,
        sport: typing.Optional[str] = None,
    ) -> typing.Union[
        ...
        args = self._rivals_all_mapped_args(
            version=version,
            sport=sport,
        )
        return await self._arivals_all_oapg(
