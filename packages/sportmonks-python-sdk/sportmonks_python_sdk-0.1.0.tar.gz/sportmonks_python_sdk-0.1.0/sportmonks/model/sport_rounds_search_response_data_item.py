...
class SportRoundsSearchResponseDataItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "sport_id", "league_id", "season_id", "stage_id", "name", "finished", "is_current", "starting_at", "ending_at", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "sport_id", "league_id", "season_id", "stage_id", "name", "finished", "is_current", "starting_at", "ending_at", ], str]):
    ...
    ) -> 'SportRoundsSearchResponseDataItem':
