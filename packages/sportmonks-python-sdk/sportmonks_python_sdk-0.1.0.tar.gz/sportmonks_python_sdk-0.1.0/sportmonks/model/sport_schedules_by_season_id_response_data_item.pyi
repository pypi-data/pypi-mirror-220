...
class SportSchedulesBySeasonIdResponseDataItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def rounds() -> typing.Type['SportSchedulesBySeasonIdResponseDataItemRounds']:
                return SportSchedulesBySeasonIdResponseDataItemRounds
        
            @staticmethod
            def aggregates() -> typing.Type['SportSchedulesBySeasonIdResponseDataItemAggregates']:
                return SportSchedulesBySeasonIdResponseDataItemAggregates
            __annotations__ = {
                "id": id,
                "sport_id": sport_id,
                "league_id": league_id,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["rounds"]) -> 'SportSchedulesBySeasonIdResponseDataItemRounds': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["aggregates"]) -> 'SportSchedulesBySeasonIdResponseDataItemAggregates': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["rounds"]) -> typing.Union['SportSchedulesBySeasonIdResponseDataItemRounds', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["aggregates"]) -> typing.Union['SportSchedulesBySeasonIdResponseDataItemAggregates', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        rounds: typing.Union['SportSchedulesBySeasonIdResponseDataItemRounds', schemas.Unset] = schemas.unset,
        aggregates: typing.Union['SportSchedulesBySeasonIdResponseDataItemAggregates', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'SportSchedulesBySeasonIdResponseDataItem':
