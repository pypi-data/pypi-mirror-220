...
class SportPlayerByIdResponseData(
    schemas.DictSchema
):
    """
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        detailed_position_id: typing.Union[MetaOapg.properties.detailed_position_id, None, str, schemas.Unset] = schemas.unset,
