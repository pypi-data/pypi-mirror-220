...
class SportSchedulesByTeamAndSeasonIdResponseDataItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def aggregates() -> typing.Type['SportSchedulesByTeamAndSeasonIdResponseDataItemAggregates']:
                return SportSchedulesByTeamAndSeasonIdResponseDataItemAggregates
        
            @staticmethod
            def rounds() -> typing.Type['SportSchedulesByTeamAndSeasonIdResponseDataItemRounds']:
                return SportSchedulesByTeamAndSeasonIdResponseDataItemRounds
            __annotations__ = {
                "id": id,
                "sport_id": sport_id,
                "league_id": league_id,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["aggregates"]) -> 'SportSchedulesByTeamAndSeasonIdResponseDataItemAggregates': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["rounds"]) -> 'SportSchedulesByTeamAndSeasonIdResponseDataItemRounds': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["aggregates"]) -> typing.Union['SportSchedulesByTeamAndSeasonIdResponseDataItemAggregates', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["rounds"]) -> typing.Union['SportSchedulesByTeamAndSeasonIdResponseDataItemRounds', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        aggregates: typing.Union['SportSchedulesByTeamAndSeasonIdResponseDataItemAggregates', schemas.Unset] = schemas.unset,
        rounds: typing.Union['SportSchedulesByTeamAndSeasonIdResponseDataItemRounds', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'SportSchedulesByTeamAndSeasonIdResponseDataItem':
