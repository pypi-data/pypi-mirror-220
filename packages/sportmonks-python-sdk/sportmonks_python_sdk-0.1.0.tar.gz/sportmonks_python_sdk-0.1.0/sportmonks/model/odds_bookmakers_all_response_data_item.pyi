...
class OddsBookmakersAllResponseDataItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "legacy_id", "name", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "legacy_id", "name", ], str]):
    ...
    ) -> 'OddsBookmakersAllResponseDataItem':
