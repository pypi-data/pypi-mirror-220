...
class SportStandingsLiveByLeagueIdResponseDataItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            standing_rule_id = schemas.NumberSchema
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "sport_id", "league_id", "season_id", "stage_id", "group_id", "round_id", "participant_id", "standing_rule_id", "position", "points", "result", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "sport_id", "league_id", "season_id", "stage_id", "group_id", "round_id", "participant_id", "standing_rule_id", "position", "points", "result", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        standing_rule_id: typing.Union[MetaOapg.properties.standing_rule_id, decimal.Decimal, int, float, schemas.Unset] = schemas.unset,
    ...
    ) -> 'SportStandingsLiveByLeagueIdResponseDataItem':
        return super().__new__(
            cls,
            *args,
            id=id,
