...
class SportSchedulesBySeasonIdResponseDataItemRoundsItemFixturesItemParticipantsItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def meta() -> typing.Type['SportSchedulesBySeasonIdResponseDataItemRoundsItemFixturesItemParticipantsItemMeta']:
                return SportSchedulesBySeasonIdResponseDataItemRoundsItemFixturesItemParticipantsItemMeta
            __annotations__ = {
                "id": id,
                "sport_id": sport_id,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["meta"]) -> 'SportSchedulesBySeasonIdResponseDataItemRoundsItemFixturesItemParticipantsItemMeta': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["meta"]) -> typing.Union['SportSchedulesBySeasonIdResponseDataItemRoundsItemFixturesItemParticipantsItemMeta', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        meta: typing.Union['SportSchedulesBySeasonIdResponseDataItemRoundsItemFixturesItemParticipantsItemMeta', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
