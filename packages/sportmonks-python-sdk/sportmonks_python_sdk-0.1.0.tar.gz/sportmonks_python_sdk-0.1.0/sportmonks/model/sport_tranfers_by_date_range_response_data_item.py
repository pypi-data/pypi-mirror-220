...
class SportTranfersByDateRangeResponseDataItem(
    schemas.DictSchema
):
    """
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        position_id: typing.Union[MetaOapg.properties.position_id, None, decimal.Decimal, int, float, schemas.Unset] = schemas.unset,
    ...
    ) -> 'SportTranfersByDateRangeResponseDataItem':
        return super().__new__(
            cls,
            *args,
            id=id,
