...
class RequiredSportPlayersByCountryIdResponseDataItem(TypedDict):
    pass

class OptionalSportPlayersByCountryIdResponseDataItem(TypedDict, total=False):
...
class SportPlayersByCountryIdResponseDataItem(RequiredSportPlayersByCountryIdResponseDataItem, OptionalSportPlayersByCountryIdResponseDataItem):
    pass
