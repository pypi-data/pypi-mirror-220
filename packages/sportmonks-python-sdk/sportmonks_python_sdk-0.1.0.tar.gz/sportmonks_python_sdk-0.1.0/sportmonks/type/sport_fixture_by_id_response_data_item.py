...
class RequiredSportFixtureByIdResponseDataItem(TypedDict):
    pass

class OptionalSportFixtureByIdResponseDataItem(TypedDict, total=False):
...
class SportFixtureByIdResponseDataItem(RequiredSportFixtureByIdResponseDataItem, OptionalSportFixtureByIdResponseDataItem):
    pass
