...
class RequiredSportFixturesAllResponseDataItem(TypedDict):
    pass

class OptionalSportFixturesAllResponseDataItem(TypedDict, total=False):
...
class SportFixturesAllResponseDataItem(RequiredSportFixturesAllResponseDataItem, OptionalSportFixturesAllResponseDataItem):
    pass
