...
class RequiredSportLivescoresLatestResponseDataItem(TypedDict):
    pass

class OptionalSportLivescoresLatestResponseDataItem(TypedDict, total=False):
...
class SportLivescoresLatestResponseDataItem(RequiredSportLivescoresLatestResponseDataItem, OptionalSportLivescoresLatestResponseDataItem):
    pass
