...
class RequiredSportCoachesByCountryIdResponseDataItem(TypedDict):
    pass

class OptionalSportCoachesByCountryIdResponseDataItem(TypedDict, total=False):
...
class SportCoachesByCountryIdResponseDataItem(RequiredSportCoachesByCountryIdResponseDataItem, OptionalSportCoachesByCountryIdResponseDataItem):
    pass
