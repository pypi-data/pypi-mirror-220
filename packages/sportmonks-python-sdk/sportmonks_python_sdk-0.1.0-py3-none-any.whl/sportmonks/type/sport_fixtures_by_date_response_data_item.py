...
class RequiredSportFixturesByDateResponseDataItem(TypedDict):
    pass

class OptionalSportFixturesByDateResponseDataItem(TypedDict, total=False):
...
class SportFixturesByDateResponseDataItem(RequiredSportFixturesByDateResponseDataItem, OptionalSportFixturesByDateResponseDataItem):
    pass
