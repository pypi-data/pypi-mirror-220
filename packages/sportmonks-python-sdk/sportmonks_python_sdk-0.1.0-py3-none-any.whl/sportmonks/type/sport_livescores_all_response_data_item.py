...
class RequiredSportLivescoresAllResponseDataItem(TypedDict):
    pass

class OptionalSportLivescoresAllResponseDataItem(TypedDict, total=False):
...
class SportLivescoresAllResponseDataItem(RequiredSportLivescoresAllResponseDataItem, OptionalSportLivescoresAllResponseDataItem):
    pass
