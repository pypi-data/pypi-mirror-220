...
class RequiredSportVenuesAllResponseDataItem(TypedDict):
    pass
...
class SportVenuesAllResponseDataItem(RequiredSportVenuesAllResponseDataItem, OptionalSportVenuesAllResponseDataItem):
    pass
