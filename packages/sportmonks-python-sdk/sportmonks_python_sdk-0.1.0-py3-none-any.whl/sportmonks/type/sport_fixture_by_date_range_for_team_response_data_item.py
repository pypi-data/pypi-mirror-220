...
class RequiredSportFixtureByDateRangeForTeamResponseDataItem(TypedDict):
    pass

class OptionalSportFixtureByDateRangeForTeamResponseDataItem(TypedDict, total=False):
...
class SportFixtureByDateRangeForTeamResponseDataItem(RequiredSportFixtureByDateRangeForTeamResponseDataItem, OptionalSportFixtureByDateRangeForTeamResponseDataItem):
    pass
