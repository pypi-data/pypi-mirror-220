...
class RequiredSportFixturesByDateRangeResponseDataItem(TypedDict):
    pass

class OptionalSportFixturesByDateRangeResponseDataItem(TypedDict, total=False):
...
class SportFixturesByDateRangeResponseDataItem(RequiredSportFixturesByDateRangeResponseDataItem, OptionalSportFixturesByDateRangeResponseDataItem):
    pass
