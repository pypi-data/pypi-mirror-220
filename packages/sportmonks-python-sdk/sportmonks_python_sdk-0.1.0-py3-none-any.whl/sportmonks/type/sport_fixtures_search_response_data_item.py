...
class RequiredSportFixturesSearchResponseDataItem(TypedDict):
    pass

class OptionalSportFixturesSearchResponseDataItem(TypedDict, total=False):
...
class SportFixturesSearchResponseDataItem(RequiredSportFixturesSearchResponseDataItem, OptionalSportFixturesSearchResponseDataItem):
    pass
