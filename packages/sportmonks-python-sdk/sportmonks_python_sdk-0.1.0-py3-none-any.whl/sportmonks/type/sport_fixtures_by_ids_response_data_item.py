...
class RequiredSportFixturesByIdsResponseDataItem(TypedDict):
    pass

class OptionalSportFixturesByIdsResponseDataItem(TypedDict, total=False):
...
class SportFixturesByIdsResponseDataItem(RequiredSportFixturesByIdsResponseDataItem, OptionalSportFixturesByIdsResponseDataItem):
    pass
