...
from sportmonks.model.sport_teams_all_response import SportTeamsAllResponse as SportTeamsAllResponseSchema

from sportmonks.type.sport_teams_all_response import SportTeamsAllResponse
...
SchemaFor0ResponseBodyApplicationJson = SportTeamsAllResponseSchema


@dataclass
class ApiResponseForDefault(api_client.ApiResponse):
    body: SportTeamsAllResponse
...
class TeamsAll(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ateams_all(
        self,
        version: typing.Optional[str] = None,
        sport: typing.Optional[str] = None,
    ) -> typing.Union[
        ...
        args = self._teams_all_mapped_args(
            version=version,
            sport=sport,
        )
        return await self._ateams_all_oapg(
