...
from sportmonks.model.sport_squads_by_season_and_team_id_response import SportSquadsBySeasonAndTeamIdResponse as SportSquadsBySeasonAndTeamIdResponseSchema

from sportmonks.type.sport_squads_by_season_and_team_id_response import SportSquadsBySeasonAndTeamIdResponse
...
SchemaFor0ResponseBodyApplicationJson = SportSquadsBySeasonAndTeamIdResponseSchema


@dataclass
class ApiResponseForDefault(api_client.ApiResponse):
    body: SportSquadsBySeasonAndTeamIdResponse
...
class BaseApi(api_client.Api):
    ...
    def _squads_by_season_and_team_id_mapped_args(
        self,
        season_id: int,
        team_id: int,
    ...
    async def _asquads_by_season_and_team_id_oapg(
        self,
    ...
    def _squads_by_season_and_team_id_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
...
class SquadsBySeasonAndTeamId(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def asquads_by_season_and_team_id(
        self,
        season_id: int,
        team_id: int,
        version: typing.Optional[str] = None,
        ...
        args = self._squads_by_season_and_team_id_mapped_args(
            season_id=season_id,
            team_id=team_id,
            version=version,
            sport=sport,
        )
        return await self._asquads_by_season_and_team_id_oapg(
            path_params=args.path,
        )
    
    def squads_by_season_and_team_id(
        self,
        season_id: int,
        team_id: int,
        version: typing.Optional[str] = None,
        ...
        return self._squads_by_season_and_team_id_oapg(
            path_params=args.path,
        )
