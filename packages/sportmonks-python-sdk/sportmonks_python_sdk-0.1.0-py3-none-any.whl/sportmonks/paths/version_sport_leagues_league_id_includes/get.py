...
class BaseApi(api_client.Api):
    ...
    def _league_enrichments_mapped_args(
        self,
        league_id: int,
    ...
    async def _aleague_enrichments_oapg(
        self,
...
class LeagueEnrichments(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aleague_enrichments(
        self,
        league_id: int,
        version: typing.Optional[str] = None,
        sport: typing.Optional[str] = None,
        ...
        args = self._league_enrichments_mapped_args(
            league_id=league_id,
            version=version,
            sport=sport,
        )
        return await self._aleague_enrichments_oapg(
            path_params=args.path,
        )
    
    def league_enrichments(
        self,
        league_id: int,
        version: typing.Optional[str] = None,
        sport: typing.Optional[str] = None,
        ...
        return self._league_enrichments_oapg(
            path_params=args.path,
        )
