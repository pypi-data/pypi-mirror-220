...
from sportmonks.model.cities_get_by_id_response import CitiesGetByIdResponse as CitiesGetByIdResponseSchema

from sportmonks.type.cities_get_by_id_response import CitiesGetByIdResponse

# Path params
VersionSchema = schemas.StrSchema
CityIdSchema = schemas.IntSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'cityId': typing.Union[CityIdSchema, decimal.Decimal, int, ],
    }
)
...
request_path_city_id = api_client.PathParameter(
    name="cityId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=CityIdSchema,
    required=True,
)
SchemaFor0ResponseBodyApplicationJson = CitiesGetByIdResponseSchema


@dataclass
class ApiResponseForDefault(api_client.ApiResponse):
    body: CitiesGetByIdResponse
