...
from sportmonks.model.sport_news_upcoming_pre_match_response import SportNewsUpcomingPreMatchResponse as SportNewsUpcomingPreMatchResponseSchema

from sportmonks.type.sport_news_upcoming_pre_match_response import SportNewsUpcomingPreMatchResponse
...
SchemaFor200ResponseBodyApplicationJson = SportNewsUpcomingPreMatchResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: SportNewsUpcomingPreMatchResponse
...
class BaseApi(api_client.Api):
    ...
    def _news_upcoming_pre_match_mapped_args(
        self,
    ...
    async def _anews_upcoming_pre_match_oapg(
        self,
    ...
    def _news_upcoming_pre_match_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
...
class NewsUpcomingPreMatch(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def anews_upcoming_pre_match(
        self,
        version: typing.Optional[str] = None,
        sport: typing.Optional[str] = None,
    ) -> typing.Union[
        ...
        args = self._news_upcoming_pre_match_mapped_args(
            version=version,
            sport=sport,
        )
        return await self._anews_upcoming_pre_match_oapg(
            path_params=args.path,
        )
    
    def news_upcoming_pre_match(
        self,
        version: typing.Optional[str] = None,
        sport: typing.Optional[str] = None,
    ) -> typing.Union[
        ...
        return self._news_upcoming_pre_match_oapg(
            path_params=args.path,
        )
