...
from sportmonks.model.regions_get_by_id_response import RegionsGetByIdResponse as RegionsGetByIdResponseSchema

from sportmonks.type.regions_get_by_id_response import RegionsGetByIdResponse

# Path params
VersionSchema = schemas.StrSchema
RegionIdSchema = schemas.IntSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'regionId': typing.Union[RegionIdSchema, decimal.Decimal, int, ],
    }
)
...
request_path_region_id = api_client.PathParameter(
    name="regionId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=RegionIdSchema,
    required=True,
)
SchemaFor0ResponseBodyApplicationJson = RegionsGetByIdResponseSchema


@dataclass
class ApiResponseForDefault(api_client.ApiResponse):
    body: RegionsGetByIdResponse
