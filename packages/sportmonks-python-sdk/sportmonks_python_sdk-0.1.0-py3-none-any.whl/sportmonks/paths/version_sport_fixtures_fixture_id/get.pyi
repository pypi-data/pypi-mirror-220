...
from sportmonks.model.sport_fixture_by_id_response import SportFixtureByIdResponse as SportFixtureByIdResponseSchema

from sportmonks.type.sport_fixture_by_id_response import SportFixtureByIdResponse
...
SchemaFor0ResponseBodyApplicationJson = SportFixtureByIdResponseSchema


@dataclass
class ApiResponseForDefault(api_client.ApiResponse):
    body: SportFixtureByIdResponse
...
class BaseApi(api_client.Api):
    ...
    def _fixture_by_id_mapped_args(
        self,
        fixture_id: int,
    ...
    async def _afixture_by_id_oapg(
        self,
...
class FixtureById(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def afixture_by_id(
        self,
        fixture_id: int,
        version: typing.Optional[str] = None,
        sport: typing.Optional[str] = None,
        ...
        args = self._fixture_by_id_mapped_args(
            fixture_id=fixture_id,
            version=version,
            sport=sport,
        )
        return await self._afixture_by_id_oapg(
    ...
    def fixture_by_id(
        ...
        return self._fixture_by_id_oapg(
            path_params=args.path,
        )
