...
class BaseApi(api_client.Api):
    ...
    def _leagues_current_by_team_id_mapped_args(
        self,
        team_id: int,
    ...
    async def _aleagues_current_by_team_id_oapg(
        self,
    ...
    def _leagues_current_by_team_id_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
...
class LeaguesCurrentByTeamId(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aleagues_current_by_team_id(
        self,
        team_id: int,
        version: typing.Optional[str] = None,
        sport: typing.Optional[str] = None,
        ...
        args = self._leagues_current_by_team_id_mapped_args(
            team_id=team_id,
            version=version,
            sport=sport,
        )
        return await self._aleagues_current_by_team_id_oapg(
            path_params=args.path,
        )
    
    def leagues_current_by_team_id(
        self,
        team_id: int,
        version: typing.Optional[str] = None,
        sport: typing.Optional[str] = None,
        ...
        return self._leagues_current_by_team_id_oapg(
            path_params=args.path,
        )
