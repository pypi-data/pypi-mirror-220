...
class SportTopScorersByStageIdResponseDataItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["stage_id", "player_id", "type_id", "team_id", "position", "total", "points", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["stage_id", "player_id", "type_id", "team_id", "position", "total", "points", ], str]):
    ...
    ) -> 'SportTopScorersByStageIdResponseDataItem':
        return super().__new__(
            cls,
            *args,
            stage_id=stage_id,
