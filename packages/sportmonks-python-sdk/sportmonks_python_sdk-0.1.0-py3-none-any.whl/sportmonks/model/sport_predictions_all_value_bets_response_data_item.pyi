...
class SportPredictionsAllValueBetsResponseDataItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def predictions() -> typing.Type['SportPredictionsAllValueBetsResponseDataItemPredictions']:
                return SportPredictionsAllValueBetsResponseDataItemPredictions
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["predictions"]) -> 'SportPredictionsAllValueBetsResponseDataItemPredictions': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["predictions"]) -> typing.Union['SportPredictionsAllValueBetsResponseDataItemPredictions', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        predictions: typing.Union['SportPredictionsAllValueBetsResponseDataItemPredictions', schemas.Unset] = schemas.unset,
    ...
    ) -> 'SportPredictionsAllValueBetsResponseDataItem':
