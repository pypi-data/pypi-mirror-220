...
class SportSeasonsAllResponseDataItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            tie_breaker_rule_id = schemas.NumberSchema
            ...
            standings_recalculated_at = schemas.StrSchema
            __annotations__ = {
                "id": id,
                "sport_id": sport_id,
                "league_id": league_id,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["tie_breaker_rule_id"]) -> MetaOapg.properties.tie_breaker_rule_id: ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["standings_recalculated_at"]) -> MetaOapg.properties.standings_recalculated_at: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "sport_id", "league_id", "tie_breaker_rule_id", "name", "finished", "pending", "is_current", "starting_at", "ending_at", "standings_recalculated_at", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["tie_breaker_rule_id"]) -> typing.Union[MetaOapg.properties.tie_breaker_rule_id, schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["standings_recalculated_at"]) -> typing.Union[MetaOapg.properties.standings_recalculated_at, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "sport_id", "league_id", "tie_breaker_rule_id", "name", "finished", "pending", "is_current", "starting_at", "ending_at", "standings_recalculated_at", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        tie_breaker_rule_id: typing.Union[MetaOapg.properties.tie_breaker_rule_id, decimal.Decimal, int, float, schemas.Unset] = schemas.unset,
        ...
        standings_recalculated_at: typing.Union[MetaOapg.properties.standings_recalculated_at, str, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'SportSeasonsAllResponseDataItem':
        return super().__new__(
            cls,
            *args,
            id=id,
