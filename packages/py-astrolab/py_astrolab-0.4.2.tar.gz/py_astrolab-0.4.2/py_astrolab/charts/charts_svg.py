...
class MakeSvgInstance:
    ...
    def __makeHouses(self, r):
        ...
        for i in range(xr):
            ...
            path = path + f'<text class="houseLabel" id="{house_by_index[i+1]} House Label" style="fill: #000000; fill-opacity: 1; font-size: 1em; font-weight: bold"><tspan x="' + \
                str(xtext-12)+'" y="'+str(ytext+3) + \
