"""The |pydwf.core.api.digital_swd| module provides a single class: |DigitalSwd|."""
...
class DigitalSwd(AbstractDwfDeviceSubApi):
    """The |DigitalSwd| class provides access to the SWD bus protocol functionality of a |DwfDevice:link|.
    ...
    Attention:
        ...
        |digitalSwd:link| attribute for access by the user.
    """
