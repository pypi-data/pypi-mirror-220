...
class Axis:
    def __init__(self, **kwargs):
        ...
        PARAMETERS:
            ...
            vmin:
                ...
                Note:
                    "vmin" Singnificant only for Geometry Plot.
                Types: int OR float
            ...
            vmax:
                ...
                Note:
                    "vmax" Singnificant only for Geometry Plot.
                For example:
        ...
        EXAMPLES:
            ...
            >>> from teradataml import Axis
            >>> ax = Axis(ytick_format="99999.99", style='dark green')
    ...
    @property
    def style(self):
        """ Getter for argument "style". """
        return self.__get_param("style")

    @style.setter
    def style(self, value):
        """ Setter for argument "style". """
        return self.__set_param("style", value)
    ...
    def __get_series_parameters(self):
        ...
        for index in range(len(self.__y_axis_data)):
            ...
            color = self._get_series_param(self.style, index)
            if color:
    ...
    def __get_label(data):
        ...
        if isinstance(data[0], tuple):
            ...
            return " / ".join(("{} - {}".format(_rpl_spcl_chars(c[0].compile()), _rpl_spcl_chars(c[1].compile())) for c in data))
