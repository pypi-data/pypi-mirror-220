...
class _Plot:
    def __init__(self, x, y, kind='line', **kwargs):
        """
        DESCRIPTION:
        ...
        RAISES:
            TeradataMlException
        """
        # TODO: Validate x, y and data here. kwargs will be validated in Axis.
        ...
        # Get figure. If user do not passed, create a default one.
        ...
        # Set the axis data.
        axis._set_data(x, y, scale=kwargs.get("scale"))
