...
class FLAME(nn.Module):
    ...
    """
    def __init__(self, ckpt_folder_path, indexes):
        ...
        self.indexes = torch.tensor(np.array(indexes, dtype=np.long), device=self.neck_kin_chain.device).unsqueeze(0)
    ...
    def forward(self, shape_params=None, expression_params=None, pose_params=None, eye_pose_params=None):
        ...
        landmarks_756_3d = vertices.squeeze()[self.indexes.squeeze()].unsqueeze(0)
