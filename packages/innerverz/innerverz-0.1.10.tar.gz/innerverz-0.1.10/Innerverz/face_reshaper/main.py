...
from .vis_utils.vis_846 import contour_lines_846
...
class Face_Reshaper(nn.Module):
    def __init__(self, img_size : int = 512, color_num : int = 68, folder_name='face_reshaper', ckpt_name = 'G_4k_846_latest.pt', force=False, device = 'cuda'):
        """
            Related Links
            --------
        ...
        if color_num == 68:
            ...
            self.contour_lines = np.array(contour_lines_846)
            self.colors = set_random_colors(num=color_num)
