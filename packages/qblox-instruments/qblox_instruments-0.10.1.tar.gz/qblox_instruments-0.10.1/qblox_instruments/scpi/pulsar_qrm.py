...
class PulsarQrm(Ieee488_2):
    ...
    def __init__(self, transport: Transport, debug: int=0):
        ...
        if self._debug == 0:
            ...
            build_ref = "fwVersion=0.10.0 fwBuild=25/04/2023-04:49:58 fwHash=0x20050738 fwDirty=0 kmodVersion=0.10.0 kmodBuild=26/04/2023-16:18:08 kmodHash=0xF3F7DB43 kmodDirty=0 swVersion=0.10.0 swBuild=26/04/2023-16:18:08 swHash=0xF3F7DB43 swDirty=0 cfgManVersion=0.2.0 cfgManBuild=26/04/2023-16:18:08 cfgManHash=0xF3F7DB43 cfgManDirty=0"
            if build != build_ref:
