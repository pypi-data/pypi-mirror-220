...
class Cluster(Ieee488_2):
    ...
    def __init__(self, transport: Transport, debug: int=0):
        ...
        if self._debug == 0:
            ...
            build_ref = "fwVersion=0.5.0 fwBuild=24/04/2023-20:35:55 fwHash=0x8593C75C fwDirty=0 kmodVersion=0.5.1 kmodBuild=18/07/2023-09:07:02 kmodHash=0x66B6C63 kmodDirty=0 swVersion=0.5.1 swBuild=18/07/2023-09:07:02 swHash=0x66B6C63 swDirty=0 cfgManVersion=0.2.0 cfgManBuild=18/07/2023-09:07:02 cfgManHash=0x66B6C63 cfgManDirty=0"
            if build != build_ref:
