...
INSERT INTO audit.cfg SELECT 'fura.usrtype',       'id',                       'modified_by|tm_stamp', NULL, NULL, NULL, 'modified_by', 'M' WHERE NOT EXISTS (SELECT id FROM audit.cfg WHERE id = 'fura.usrtype');
