  ...
  id = :id for update nowait""")
    ...
    def fetch(self, must_exist: bool = False) -> bool:
        ...
        if not self._dbcon.fetch(self._dbstmnt):
            if must_exist:
                raise mettle.lib.xMettle(f"Record not found: [table:Usr, proc:LockOne, row:{self.irec}]", err_code=mettle.lib.xMettle.eCode.DBNotFound)
            return False
    ...
    def fetch_all(self, out_list: tUsr.List, clear_list: bool = True) -> int:
        """
