...
from .schemas import And, Optional, Schema, SchemaContext, Stripped, Use
...
class Config(ConfigBase):
	...
	__schema = Schema({
		...
		And(Stripped(str, allow_empty=False, name=r'struct name'), Use(utils.to_snake_case)) : { object : object }
		},
