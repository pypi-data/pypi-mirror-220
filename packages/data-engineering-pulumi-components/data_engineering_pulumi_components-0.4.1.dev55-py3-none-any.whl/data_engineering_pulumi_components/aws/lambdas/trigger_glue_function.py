...
class TriggerGlueFunction(ComponentResource):
    def __init__(
        ...
        self._rolePolicy = RolePolicy(
            resource_name=f"{name}-assume-glue-role",
        ...
        self._function = Function(
            resource_name=f"{name}-trigger-glue",
            code=AssetArchive(
                assets={
                    ".": FileArchive(
