...
class DriftDetectionRules():
    ...
    def add(self, type:StringElement, metric:StringElement, _class:StringElement, threshold:FloatElement):
        self.rules.append({ "type" : type.get(), "metric" : metric.get(),  "class": _class.get(), "threshold":threshold.get() })
