...
def make_arg(model_name, inference_col_name, embedding_col_name):
    return [
        {"customerColumnName": "ImageId", "type": "imageName", "modelName": "", "ref_col_name": ""},
        {"customerColumnName": f"{inference_col_name}_{model_name}", "type": "inference", "modelName": model_name, "ref_col_name": ""},
        {"customerColumnName": f"{embedding_col_name}_{model_name}", "type": "imageEmbedding", "modelName": model_name, "ref_col_name": ""}
    ]
