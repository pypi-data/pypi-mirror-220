...
run_name= "K_COCO_19Jul_V2_v6" # Experiment Name
dataset_name = "k_coco_Ds_19jul_V2" # Dataset Name
...
test_ds.load(data="macoco.json", format="coco", model_name="modelA", inference_col_name="annotations1",embedding_col_name="embeddings1")
test_ds.load(data="mbcoco.json", format="coco", model_name="modelB", inference_col_name="annotations2",embedding_col_name="embeddings2")
test_ds.load(data="gtcoco.json", format="coco", model_name="modelG", inference_col_name="annotations3",embedding_col_name="embeddings3")
