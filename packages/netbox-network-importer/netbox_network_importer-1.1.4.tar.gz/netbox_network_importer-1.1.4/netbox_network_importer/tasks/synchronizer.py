...
from netbox_network_importer.pyats.parser import show_interfaces, show_interface, show_vlan, show_interfaces_status, show_interfaces_trunk, show_interface_switchport
from netbox_network_importer.data_converter.network_to_netbox import convert_interfaces, convert_lag_interfaces, convert_interfaces_ips, convert_interfaces_vlans_iosxr, convert_interfaces_vlans_iosxe, convert_interfaces_vlans_nxos
...
def synchronize_interfaces_lags(task: Task, pyats) -> Result:
    ...
    try:
        if task.host.platform in ['nxos', 'nxos_ssh']:
            genie_interfaces = show_interface(
