...
if TYPE_CHECKING:
    from ..models.plugin_with_relations_cwl_script import PluginWithRelationsCwlScript
    from ..models.plugin_with_relations_inputs_item import PluginWithRelationsInputsItem
    from ..models.plugin_with_relations_outputs_item import PluginWithRelationsOutputsItem
    from ..models.plugin_with_relations_plugin_hardware_requirements import (
        PluginWithRelationsPluginHardwareRequirements,
    )
    from ..models.plugin_with_relations_ui_item import PluginWithRelationsUiItem


T = TypeVar("T", bound="PluginWithRelations")


@attr.s(auto_attribs=True)
class PluginWithRelations:
    """(tsType: PluginWithRelations, schemaOptions: { includeRelations: true })
    ...
    Attributes:
        ...
        inputs (Union[Unset, List['PluginWithRelationsInputsItem']]):
        outputs (Union[Unset, List['PluginWithRelationsOutputsItem']]):
        custom_inputs (Union[Unset, bool]):
        ui (Union[Unset, List['PluginWithRelationsUiItem']]):
        ...
        plugin_hardware_requirements (Union[Unset, PluginWithRelationsPluginHardwareRequirements]):
        cwl_script (Union[Unset, PluginWithRelationsCwlScript]):
    """
    ...
    inputs: Union[Unset, List["PluginWithRelationsInputsItem"]] = UNSET
    outputs: Union[Unset, List["PluginWithRelationsOutputsItem"]] = UNSET
    custom_inputs: Union[Unset, bool] = UNSET
    ui: Union[Unset, List["PluginWithRelationsUiItem"]] = UNSET
    ...
    plugin_hardware_requirements: Union[Unset, "PluginWithRelationsPluginHardwareRequirements"] = UNSET
    cwl_script: Union[Unset, "PluginWithRelationsCwlScript"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for inputs_item_data in _inputs or []:
            inputs_item = PluginWithRelationsInputsItem.from_dict(inputs_item_data)
        ...
        for outputs_item_data in _outputs or []:
            outputs_item = PluginWithRelationsOutputsItem.from_dict(outputs_item_data)
        ...
        for ui_item_data in _ui or []:
            ui_item = PluginWithRelationsUiItem.from_dict(ui_item_data)
        ...
        if isinstance(_plugin_hardware_requirements, Unset):
            ...
            plugin_hardware_requirements = PluginWithRelationsPluginHardwareRequirements.from_dict(
                _plugin_hardware_requirements
            )
        ...
        if isinstance(_cwl_script, Unset):
            ...
            cwl_script = PluginWithRelationsCwlScript.from_dict(_cwl_script)

        plugin_with_relations = cls(
            version=version,
            id=id,
            cwl_id=cwl_id,
            name=name,
        ...
        plugin_with_relations.additional_properties = d
        return plugin_with_relations
