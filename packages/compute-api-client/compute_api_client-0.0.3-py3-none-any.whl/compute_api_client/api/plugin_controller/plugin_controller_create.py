...
from ...models.new_scripts import NewScripts
...
def _get_kwargs(
    *,
    client: Client,
    json_body: NewScripts,
) -> Dict[str, Any]:
    url = "{}/compute/plugins".format(client.base_url)
...
def sync_detailed(
    *,
    ...
    """
    Args:
        json_body (NewScripts): (tsType: Omit<Plugin, 'id'>, schemaOptions: { title: 'NewScripts',
            exclude: [ 'id' ] })
