...
if TYPE_CHECKING:
    from ..models.plugin_cwl_script import PluginCwlScript
    from ..models.plugin_inputs_item import PluginInputsItem
    from ..models.plugin_outputs_item import PluginOutputsItem
    from ..models.plugin_plugin_hardware_requirements import PluginPluginHardwareRequirements
    from ..models.plugin_ui_item import PluginUiItem
...
class Plugin:
    ...
    Attributes:
        ...
        inputs (Union[Unset, List['PluginInputsItem']]):
        outputs (Union[Unset, List['PluginOutputsItem']]):
        custom_inputs (Union[Unset, bool]):
        ui (Union[Unset, List['PluginUiItem']]):
        ...
        plugin_hardware_requirements (Union[Unset, PluginPluginHardwareRequirements]):
        cwl_script (Union[Unset, PluginCwlScript]):
    """
    ...
    inputs: Union[Unset, List["PluginInputsItem"]] = UNSET
    outputs: Union[Unset, List["PluginOutputsItem"]] = UNSET
    custom_inputs: Union[Unset, bool] = UNSET
    ui: Union[Unset, List["PluginUiItem"]] = UNSET
    ...
    plugin_hardware_requirements: Union[Unset, "PluginPluginHardwareRequirements"] = UNSET
    cwl_script: Union[Unset, "PluginCwlScript"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for inputs_item_data in _inputs or []:
            inputs_item = PluginInputsItem.from_dict(inputs_item_data)
        ...
        for outputs_item_data in _outputs or []:
            outputs_item = PluginOutputsItem.from_dict(outputs_item_data)
        ...
        for ui_item_data in _ui or []:
            ui_item = PluginUiItem.from_dict(ui_item_data)
        ...
        if isinstance(_plugin_hardware_requirements, Unset):
            ...
            plugin_hardware_requirements = PluginPluginHardwareRequirements.from_dict(_plugin_hardware_requirements)
        ...
        if isinstance(_cwl_script, Unset):
            ...
            cwl_script = PluginCwlScript.from_dict(_cwl_script)
