...
if TYPE_CHECKING:
    from ..models.workflow_cwl_job_inputs import WorkflowCwlJobInputs
    from ..models.workflow_inputs import WorkflowInputs
    from ..models.workflow_outputs import WorkflowOutputs
...
class Workflow:
    ...
    Attributes:
        ...
        steps (WorkflowSteps):
        cwl_job_inputs (WorkflowCwlJobInputs):
        id (Union[Unset, str]):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        inputs = WorkflowInputs.from_dict(d.pop("inputs"))

        outputs = WorkflowOutputs.from_dict(d.pop("outputs"))

        steps = WorkflowSteps.from_dict(d.pop("steps"))

        cwl_job_inputs = WorkflowCwlJobInputs.from_dict(d.pop("cwlJobInputs"))
