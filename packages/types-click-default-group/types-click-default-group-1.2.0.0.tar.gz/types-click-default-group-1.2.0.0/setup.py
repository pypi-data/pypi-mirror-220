...
This is a PEP 561 type stub package for the `click-default-group` package. It
can be used by type-checking tools like
[mypy](https://github.com/python/mypy/),
[pyright](https://github.com/microsoft/pyright),
[pytype](https://github.com/google/pytype/),
PyCharm, etc. to check code that uses
`click-default-group`. The source for this package can be found at
https://github.com/python/typeshed/tree/main/stubs/click-default-group. All fixes for
...
setup(name=name,
      ...
      package_data={'click_default_group-stubs': ['__init__.pyi', 'METADATA.toml']},
