...
def run():
    ...
    # im = Image.open("./vhmap/threejsmod/wget/mars_textures/mars_posy.jpg")
    # angle = 180
    # out = im.rotate(angle)
    # out.save("./vhmap/threejsmod/wget/mars_textures/mars_posy_fix.jpg")
    ...
    # if not os.path.exists("./vhmap/threejsmod/wget/sun_bg.jpg"):
    #     os.system('cd ./vhmap/threejsmod/wget && wget https://raw.githubusercontent.com/iWun/solar-system/master/img/sun_bg.jpg')
    # (2) declear geo
