...
setup(
    ...
    version='0.0.1',         # Replace with your desired version number
    author='evans.zhu',
    ...
    packages=['bcitoolbox'],
    install_requires=['numpy', 'matplotlib','csv','time','random','scipy','os', 'tkinter'],  # Add any dependencies required by your function
    classifiers=[
