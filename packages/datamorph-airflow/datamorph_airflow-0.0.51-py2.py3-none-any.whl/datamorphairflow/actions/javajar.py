...
class DMRunJavaJarOperator(BashOperator):
    ...
    def __init__(
        ...
        cmd = 'java -cp ' + arguments + ' ' + jarPath + ' ' + systemparams + ' ' + DEFAULT_CLASSNAME
    ...
    def execute(self, context):
        ...
        if utils.is_s3_file(self.jarpath):
            ...
            cmd = 'java ' + self.arguments + ' -cp ' + ' ' + tempPath + ' ' + dag_system_params + " " + self.classname
            self.bash_command = cmd
            ...
            # step3: create bash command and execute
            cmd = 'java ' + self.arguments + ' -cp ' + ' ' + self.jarpath + ' ' + dag_system_params + " " + self.classname
            self.bash_command = cmd
            return_value = super(DMRunJavaJarOperator, self).execute(context)
