...
from ezoognnexample.fullgraph.gat.gat import GAT
from ezoognnexample.fullgraph.gat.utils import EarlyStopping
...
def main(args):
    ...
    if args.ezoo_fullgraph is not None and args.ezoo_fullgraph:
        if args.dataset == 'Cora':
            data = EzooGraphDataset(cfg_file=args.cfg_file)[EzooShapeGraphEnum.WHOLE]
        elif args.dataset == 'Citeseer':
            data = CiteseerEzooGraphDataset(cfg_file=args.cfg_file)[EzooShapeGraphEnum.WHOLE]
        elif args.dataset == 'Pubmed':
            data = PubmedEzooGraphDataset(cfg_file=args.cfg_file)[EzooShapeGraphEnum.WHOLE]
    else:
        if args.dataset == 'Cora':
    ...
    n_edges = data[0].number_of_edges()#data.graph.number_of_edges()
...
if __name__ == '__main__':
    ...
    parser.add_argument("-cfg", "--cfg-file", type=str, default='/home/zz/project/ezoodb/.tmp/.config/conf.conf',
