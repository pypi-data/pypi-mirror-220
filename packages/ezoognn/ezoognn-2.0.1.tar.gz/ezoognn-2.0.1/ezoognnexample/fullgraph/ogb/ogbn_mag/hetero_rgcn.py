...
def prepare_data(args, device):
    ...
    import time
    start = time.time()
    dataset = OgbnEzooHeteroGraphDataset(name=EzooExampleDatasetEnum.OGBN_MAG.value, cfg_file=args.cfg_file)
    g, _ = dataset[EzooShapeGraphEnum.WHOLE]
    split_idx = dataset.get_idx_split()['node_mask']
    ...
    return g, labels, num_classes, split_idx, logger, train_loader
...
if __name__ == "__main__":
    ...
    parser.add_argument("--cfg_file", type=str, default=os.path.join(current_dir, "../../../../../../resources/conf/ezoodb.conf"))
