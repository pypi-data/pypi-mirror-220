...
class RedisUtils(object):
    ...
    def blpop(self, key, timeout: Optional[int] = 0):
        return self.__redis.blpop(key, timeout=timeout)

    def brpop(self, key, timeout: Optional[int] = 0):
        return self.__redis.brpop(key, timeout=timeout)
