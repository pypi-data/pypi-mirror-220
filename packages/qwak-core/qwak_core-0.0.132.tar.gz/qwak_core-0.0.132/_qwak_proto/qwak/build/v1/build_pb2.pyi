...
class Feature(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["batch_feature", b"batch_feature", "explicit_feature", b"explicit_feature", "on_the_fly_feature", b"on_the_fly_feature", "request_input", b"request_input", "streaming_feature", b"streaming_feature", "type", b"type"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["batch_feature", b"batch_feature", "explicit_feature", b"explicit_feature", "on_the_fly_feature", b"on_the_fly_feature", "request_input", b"request_input", "streaming_feature", b"streaming_feature", "type", b"type"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["type", b"type"]) -> typing_extensions.Literal["batch_feature", "explicit_feature", "on_the_fly_feature", "streaming_feature", "request_input"] | None: ...
...
class BuildFilter(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["metric_filters", b"metric_filters", "parameter_filters", b"parameter_filters", "tags", b"tags"]) -> None: ...
