...
def connect_entrypoint(
    ...
    **kwargs,
    ...
    if name:
        ...
        # If runs are passed in, don't perform another query
        available_runs = runs or get_runs(statuses=[RunStatus.STARTING, RunStatus.RUNNING], include_interactive=True)
