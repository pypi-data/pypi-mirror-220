...
def import_dataset(name:str, data:str, hf_token=None, force_download:bool=False)->ndarray:
    ...
    hf_token : str
        HuggingFace token to use to download the dataset from HuggingFace Hub. Defaults to None.
    force_download : bool
