...
APPEND_SAMPLE = " Considering every selection where clause criteria without missing any, Columns in the select queries will be given appropriate names, always comparing strings " \
