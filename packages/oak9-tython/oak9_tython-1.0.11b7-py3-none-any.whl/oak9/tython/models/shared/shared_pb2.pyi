...
class Finding(google.protobuf.message.Message):
    ...
    REQUIREMENT_ID_FIELD_NUMBER: builtins.int
    REQUIREMENT_NAME_FIELD_NUMBER: builtins.int
    ...
    requirement_id: builtins.str
    requirement_name: builtins.str
    def __init__(
        self,
        *,
        finding_type: global___FindingType.ValueType = ...,
    ...
    def ClearField(self, field_name: typing_extensions.Literal["config_id", b"config_id", "current_value", b"current_value", "description", b"description", "documentation_url", b"documentation_url", "finding_type", b"finding_type", "fix", b"fix", "impact_rating", b"impact_rating", "preferred_value", b"preferred_value", "requirement_id", b"requirement_id", "requirement_name", b"requirement_name", "resource", b"resource", "resource_metadata", b"resource_metadata", "severity", b"severity"]) -> None: ...
