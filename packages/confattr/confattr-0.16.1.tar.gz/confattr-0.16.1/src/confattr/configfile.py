...
class NotificationLevel:
	...
	def __new__(cls, value: str, *, new: bool = False, more_important_than: 'NotificationLevel|None' = None, less_important_than: 'NotificationLevel|None' = None) -> 'NotificationLevel':
		'''
		:return: An existing instance (see :meth:`~confattr.configfile.NotificationLevel.get`) or a new instance if :paramref:`~confattr.configfile.NotificationLevel.__new__.new` is true (see :meth:`~confattr.configfile.NotificationLevel.new`)
		...
		:param more_important_than: If :paramref:`~confattr.configfile.NotificationLevel.__new__.new` is true either this or :paramref:`~confattr.configfile.NotificationLevel.__new__.less_important_than` must be given.
		:param less_important_than: If :paramref:`~confattr.configfile.NotificationLevel.__new__.new` is true either this or :paramref:`~confattr.configfile.NotificationLevel.__new__.more_important_than` must be given.
		'''
		if new:
