...
Example:
    ```
    pai -d "~/aptpandasai/example/data/Loan payments data.csv" -m "openai"
...
from aptpandasai import PandasAI
from aptpandasai.llm.google_palm import GooglePalm
from aptpandasai.llm.openai import OpenAI
from aptpandasai.llm.starcoder import Starcoder
from aptpandasai.llm.falcon import Falcon
