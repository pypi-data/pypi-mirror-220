...
def get_crypter():
    ...
    try:
        ...
        if isinstance(configured_keys, (tuple, list)):
            ...
            keys = [
                cryptography.fernet.Fernet(configured_keys),
            ]
    except Exception as e:
        raise ImproperlyConfigured(f"FIELD_ENCRYPTION_KEY defined incorrectly: {e}") from e
...
class EncryptedNullBooleanField(EncryptedMixin, django.db.models.BooleanField):
