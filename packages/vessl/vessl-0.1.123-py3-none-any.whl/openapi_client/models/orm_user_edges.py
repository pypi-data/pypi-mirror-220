...
class OrmUserEdges(object):
    ...
    @property
    def runs(self):
        """Gets the runs of this OrmUserEdges.  # noqa: E501


        :return: The runs of this OrmUserEdges.  # noqa: E501
        :rtype: list[OrmRun]
        """
        return self._runs
    ...
    @runs.setter
    def runs(self, runs):
        """Sets the runs of this OrmUserEdges.


        :param runs: The runs of this OrmUserEdges.  # noqa: E501
