...
class OrmRunSpecEdges(object):
    ...
    def __init__(self, cluster=None, image=None, pipeline_step_specs=None, project=None, resource_spec_preset=None, run=None, run_executions=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def run(self):
        """Gets the run of this OrmRunSpecEdges.  # noqa: E501


        :return: The run of this OrmRunSpecEdges.  # noqa: E501
        :rtype: OrmRun
        """
        return self._run
    ...
    @run.setter
    def run(self, run):
        """Sets the run of this OrmRunSpecEdges.


        :param run: The run of this OrmRunSpecEdges.  # noqa: E501
        :type run: OrmRun
        """
