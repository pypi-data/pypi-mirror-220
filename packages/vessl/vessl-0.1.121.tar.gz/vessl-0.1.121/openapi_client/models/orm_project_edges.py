...
class OrmProjectEdges(object):
    ...
    def __init__(self, dashboards=None, experiment_fields=None, experiments=None, organization=None, pipelines=None, policies=None, primary_owner=None, project_datasets=None, repositories=None, run_specs=None, runs=None, service_account_subjects=None, tag_group=None, volume=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def runs(self):
        """Gets the runs of this OrmProjectEdges.  # noqa: E501


        :return: The runs of this OrmProjectEdges.  # noqa: E501
        :rtype: list[OrmRun]
        """
        return self._runs
    ...
    @runs.setter
    def runs(self, runs):
        """Sets the runs of this OrmProjectEdges.


        :param runs: The runs of this OrmProjectEdges.  # noqa: E501
        :type runs: list[OrmRun]
        """
