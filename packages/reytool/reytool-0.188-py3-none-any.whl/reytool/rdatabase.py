...
from typing import Any, List, Tuple, Dict, Iterable, Optional, Literal, Union, ClassVar, NoReturn, Never, overload
...
class REngine(object):
    ...
    def execute_insert(
        self,
        data: Union[List[Dict[Never]], Dict[Never]],
        table: str,
        database: Optional[str] = None,
    ...
    def execute_insert(
        ...
        **kwdata: Any
        ...
        if (
            ...
            raise AssertionError("parameter 'data' and 'kwdata' cannot both be empty")
