...
setuptools.setup(
    ...
    description="HOLY BIBLE Module that loads an entire HOLY BIBLE, performs searches, and displays related references. It provides functionalities to access specific chapters and verses.",
    long_description=r"""Welcome to HOLYBIBLE's Documentation!
=====================================
...
""",
    long_description_content_type="text/markdown",  # Update content type accordingly (text/markdown or text/x-rst if using reStructuredText respectively)
