    ...
    """
{
    ...
    "package_data": {
        "gammarer.aws_frontend_web_app_deploy_stack._jsii": [
            "aws-frontend-web-app-deploy-stack@0.5.0.jsii.tgz"
        ],
        "gammarer.aws_frontend_web_app_deploy_stack": [
            "py.typed"
        ]
    ...
    "install_requires": [
        ...
        "gammarer.aws-secure-cloudfront-origin-bucket>=0.6.0, <0.7.0",
        "gammarer.aws-secure-frontend-web-app-cloudfront-distribution>=0.6.0, <0.7.0",
        "jsii>=1.85.0, <2.0.0",
        "publication>=0.0.3",
        "typeguard~=2.13.3"
    ],
