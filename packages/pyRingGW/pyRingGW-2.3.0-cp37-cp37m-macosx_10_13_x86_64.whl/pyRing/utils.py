...
def F_mrg_Nagar(m1, m2, a1, a2, geom=0):
    ...
    This function returns the merger frequency of a binary black hole system. New version of the merger frequency, defined with respect to the 22 mode of the inspiral.
