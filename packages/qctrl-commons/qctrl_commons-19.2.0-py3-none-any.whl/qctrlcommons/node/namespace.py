...
class PrimaryNamespace:
    """
    Class for the primary node namespaces.
    """
...
def create_namespace(
    ...
    """
    Create a primary node namespace given a namespace name, the name of the module
    ...
    for _, obj in inspect.getmembers(sys.modules[module_name]):
        if (
            ...
            sub_nodes[new_name] = obj
    return PrimaryNamespace(namespace_name, sub_nodes, categories)
