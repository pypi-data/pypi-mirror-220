...
def plot_edf(
    deviation: AbsoluteTrajectoryDeviations | list[AbsoluteTrajectoryDeviations],
...
def plot_multiple_comb_deviations(
    ...
    for dev in deviation_list:
        ...
        if ax_rot is not None:
            ax_rot.plot(dev_sorted.function_of[arc_length_sorting], dev_sorted.comb_rot_devs[arc_length_sorting])
