...
class Trajectory:
    ...
    def __init__(
        ...
        state: TrajectoryProcessingState | None = None,
    ) -> None:
    ...
    @property
    def lap_indices(self) -> None | np.ndarray:
    ...
    def divide_into_laps(self) -> None | list["Trajectory"]:
    ...
    def interpolate(self, tstamps: list | np.ndarray, inplace: bool = True) -> "Trajectory":
    ...
    def _crop_timestamps(self, tstamps: list | np.ndarray) -> np.ndarray:
        """
    ...
    def _interpolate_rotations(self, tstamps: list | np.ndarray) -> RotationSet | None:
