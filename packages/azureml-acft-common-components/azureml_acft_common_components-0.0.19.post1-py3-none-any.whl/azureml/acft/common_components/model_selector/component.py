...
from azureml.acft.common_components.utils.error_handling.error_definitions import InvalidMlflowModelFormat, \
    ModelInputEmpty, ACFTSystemError
...
class ModelSelector:
    ...
    def _model_name_download_from_registry(self) -> None:
        """
        ...
        if model_info_response.status_code == 200:
            ...
            logger.warning(f'Model {self.model_name} was not found in registry {ModelSelectorDefaults.MODEL_REGISTRY}')
    ...
    def run_workflow(self) -> None:
        ...
        if (self.model_name is not None) and (self.pytorch_model is None) and (self.mlflow_model is None):
            self._model_name_download_from_registry()
