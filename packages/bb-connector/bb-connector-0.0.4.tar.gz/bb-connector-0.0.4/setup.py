...
class BlpapiInstall(install):
    ...
    def run(self):
        subprocess.call(['pip', 'install', "--extra-index-url", "https://bcms.bloomberg.com/pip/simple", "blpapi==3.19.3"])
        install.run(self)


with open(r'C:\Users\maidorn\IdeaProjects\bb-connector\requirements.txt') as f:
