...
from app.exts import db, migrate, ma, bcrypt, jwt
from app.router import register_blueprints
from app.core.errors import TestNewWithOptionsPypi_P0Error, ErrorHandler
...
def register_errorhandlers(app):
    app.register_error_handler(TestNewWithOptionsPypi_P0Error,
                               ErrorHandler.handle_app)
